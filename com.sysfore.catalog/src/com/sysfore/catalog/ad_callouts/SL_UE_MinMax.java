...
public class SL_UE_MinMax extends HttpSecureAppServlet {
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars, String strChanged,
    ...
    maxQty = Integer.valueOf(strMaxQty);
    ...
    resultado.append("var calloutName='SL_UE_MinMax';\n\n");
    resultado.append("var respuesta = new Array(");

    modvalue = maxQty % ueQty;
    if(maxQty == 0){
       resultado.append("new Array(\"inpmaxqty\", " + ueQty + ")");
     }
    else if(modvalue == 0){
      resultado.append("new Array(\"inpmaxqty\", " + maxQty + ")");
      }
    else {
           subvalue = ueQty - modvalue;
           total = maxQty + subvalue;
      resultado.append("new Array(\"inpmaxqty\", " + total + ")");
    }
    /*if((minQty == 0) | (maxQty == 0)){
      ...
      resultado.append("new Array(\"inpmaxqty\", \"" + ueQty + "\")\n");
          ...
          modvalue1 = maxQty % ueQty;
          subvalue1 = ueQty - modvalue1;
          total1 = maxQty + subvalue1;

      resultado.append("new Array(\"inpminqty\", \"" + total + "\"),\n");
      resultado.append("new Array(\"inpmaxqty\", \"" + total1 + "\")\n");
      }*/
    // }
      //  result.append("new Array(\"inpadmissionNo\", \"" + strAdmissionNo + "\"),"); 
