...
public class CL_Movement_Product extends SimpleCallout {
  private static final long serialVersionUID = 1L;

  @Override
  protected void execute(CalloutInfo info) throws ServletException {
    // first call the original callout
    info.executeCallout(new SL_Movement_Product());
    String strMProductID = info.vars.getStringParameter("inpmProductId");
    // add the information here.
    CLMovementLineCMNSData[] data = CLMovementLineCMNSData.select(this, strMProductID);
