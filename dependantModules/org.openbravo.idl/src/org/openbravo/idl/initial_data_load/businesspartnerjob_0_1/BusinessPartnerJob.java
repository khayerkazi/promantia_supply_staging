...
public class BusinessPartnerJob {
	...
	private class ContextProperties extends java.util.Properties {
		...
		public void synchronizeContext() {
			...
			if (numLinesRejected != null) {
				...
				this.setProperty("numLinesRejected", numLinesRejected
						.toString());
			...
			if (validationFailCause != null) {
				...
				this.setProperty("validationFailCause", validationFailCause
						.toString());
	...
	private final String jobName = "BusinessPartnerJob";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(BusinessPartnerJob.this, new Object[] { e,
									globalMap });
							break;
						}
					}
	...
	public void tJavaRow_11_error(Exception exception,
			final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tFilterRow_11_error(Exception exception,
			final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tFilterRow_10_error(Exception exception,
			final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tJavaRow_18_error(Exception exception,
			final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tJavaRow_9_error(Exception exception,
			final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tJavaRow_16_error(Exception exception,
			final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	static class row3Struct implements
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime
						* result
						+ ((this.Searchkey == null) ? 0 : this.Searchkey
								.hashCode());
			...
			synchronized (commonByteArrayLock) {
				...
				try {
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.ReferenceNo = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.Adderss1stLine = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.Address2ndLine = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.AlternativePhone = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.ShipToAddress = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.PayFromAddress = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.InvoiceToAddress = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.RemitToAddress = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.ConsumptionDays = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.ShowGeneric = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.BankAccountNo = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.ContactUser = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.ContactDescription = new String(commonByteArray,
								0, length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.ContactPhone = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.ContactAlternativePhone = new String(
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.POPaymentMethod = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.POPaymentTerms = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.PurchasePriceList = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.TaxCategory = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.POFinancialAccount = new String(commonByteArray,
								0, length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.CustomerPaymentMethod = new String(
								commonByteArray, 0, length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.PaymentTerm = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.soTaxCategory = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.CustomerFinancialAccount = new String(
								commonByteArray, 0, length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.soInvoiceSchedule = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.soInvoicesTerms = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.IsSalesRepresentative = new String(
								commonByteArray, 0, length);
					}
	...
	static class row19Struct implements
	...
	static class row23Struct implements
	...
	static class row18Struct implements
	...
	static class row16Struct implements
	...
	public void tFileInputDelimited_1Process(
		...
		try {
			...
			while (limittFileInputDelimited_1 != 0
				...
				try {
					...
					if (rowtFileInputDelimited_1.length == 1
						...
						if (0 < rowtFileInputDelimited_1.length) {
							row16.Organization = rowtFileInputDelimited_1[0]
									.trim();
						...
						if (1 < rowtFileInputDelimited_1.length) {
							row16.Searchkey = rowtFileInputDelimited_1[1]
									.trim();
						...
						if (3 < rowtFileInputDelimited_1.length) {
							row16.Description = rowtFileInputDelimited_1[3]
									.trim();
						...
						if (4 < rowtFileInputDelimited_1.length) {
							row16.TaxID = rowtFileInputDelimited_1[4].trim();
						...
						if (5 < rowtFileInputDelimited_1.length) {
							row16.TaxExempt = rowtFileInputDelimited_1[5]
									.trim();
						...
						if (6 < rowtFileInputDelimited_1.length) {
							row16.ReferenceNo = rowtFileInputDelimited_1[6]
									.trim();
						...
						if (7 < rowtFileInputDelimited_1.length) {
							row16.Category = rowtFileInputDelimited_1[7].trim();
						...
						if (8 < rowtFileInputDelimited_1.length) {
							row16.Language = rowtFileInputDelimited_1[8].trim();
						...
						if (9 < rowtFileInputDelimited_1.length) {
							row16.Adderss1stLine = rowtFileInputDelimited_1[9]
									.trim();
						...
						if (10 < rowtFileInputDelimited_1.length) {
							row16.Address2ndLine = rowtFileInputDelimited_1[10]
									.trim();
						...
						if (11 < rowtFileInputDelimited_1.length) {
							row16.PostalCode = rowtFileInputDelimited_1[11]
									.trim();
						...
						if (12 < rowtFileInputDelimited_1.length) {
							row16.City = rowtFileInputDelimited_1[12].trim();
						...
						if (13 < rowtFileInputDelimited_1.length) {
							row16.Region = rowtFileInputDelimited_1[13].trim();
						...
						if (14 < rowtFileInputDelimited_1.length) {
							row16.Country = rowtFileInputDelimited_1[14].trim();
						...
						if (15 < rowtFileInputDelimited_1.length) {
							row16.Phone = rowtFileInputDelimited_1[15].trim();
						...
						if (16 < rowtFileInputDelimited_1.length) {
							row16.AlternativePhone = rowtFileInputDelimited_1[16]
									.trim();
						...
						if (17 < rowtFileInputDelimited_1.length) {
							row16.Fax = rowtFileInputDelimited_1[17].trim();
						...
						if (18 < rowtFileInputDelimited_1.length) {
							row16.ShipToAddress = rowtFileInputDelimited_1[18]
									.trim();
						...
						if (19 < rowtFileInputDelimited_1.length) {
							row16.PayFromAddress = rowtFileInputDelimited_1[19]
									.trim();
						...
						if (20 < rowtFileInputDelimited_1.length) {
							row16.InvoiceToAddress = rowtFileInputDelimited_1[20]
									.trim();
						...
						if (21 < rowtFileInputDelimited_1.length) {
							row16.RemitToAddress = rowtFileInputDelimited_1[21]
									.trim();
						...
						if (22 < rowtFileInputDelimited_1.length) {
							row16.ConsumptionDays = rowtFileInputDelimited_1[22]
									.trim();
						...
						if (23 < rowtFileInputDelimited_1.length) {
							row16.ShowGeneric = rowtFileInputDelimited_1[23]
									.trim();
						...
						if (24 < rowtFileInputDelimited_1.length) {
							row16.ShowIban = rowtFileInputDelimited_1[24]
									.trim();
						...
						if (25 < rowtFileInputDelimited_1.length) {
							row16.BankAccountNo = rowtFileInputDelimited_1[25]
									.trim();
						...
						if (26 < rowtFileInputDelimited_1.length) {
							row16.IBAN = rowtFileInputDelimited_1[26].trim();
						...
						if (27 < rowtFileInputDelimited_1.length) {
							row16.ContactUser = rowtFileInputDelimited_1[27]
									.trim();
						...
						if (28 < rowtFileInputDelimited_1.length) {
							row16.Firstname = rowtFileInputDelimited_1[28]
									.trim();
						...
						if (29 < rowtFileInputDelimited_1.length) {
							row16.Lastname = rowtFileInputDelimited_1[29]
									.trim();
						...
						if (30 < rowtFileInputDelimited_1.length) {
							row16.ContactDescription = rowtFileInputDelimited_1[30]
									.trim();
						...
						if (31 < rowtFileInputDelimited_1.length) {
							row16.Email = rowtFileInputDelimited_1[31].trim();
						...
						if (32 < rowtFileInputDelimited_1.length) {
							row16.Position = rowtFileInputDelimited_1[32]
									.trim();
						...
						if (33 < rowtFileInputDelimited_1.length) {
							row16.ContactPhone = rowtFileInputDelimited_1[33]
									.trim();
						...
						if (34 < rowtFileInputDelimited_1.length) {
							row16.ContactAlternativePhone = rowtFileInputDelimited_1[34]
									.trim();
						...
						if (35 < rowtFileInputDelimited_1.length) {
							row16.ContactFax = rowtFileInputDelimited_1[35]
									.trim();
						...
						if (36 < rowtFileInputDelimited_1.length) {
							row16.Vendor = rowtFileInputDelimited_1[36].trim();
						...
						if (37 < rowtFileInputDelimited_1.length) {
							row16.POPaymentMethod = rowtFileInputDelimited_1[37]
									.trim();
						...
						if (38 < rowtFileInputDelimited_1.length) {
							row16.POPaymentTerms = rowtFileInputDelimited_1[38]
									.trim();
						...
						if (39 < rowtFileInputDelimited_1.length) {
							row16.PurchasePriceList = rowtFileInputDelimited_1[39]
									.trim();
						...
						if (40 < rowtFileInputDelimited_1.length) {
							row16.TaxCategory = rowtFileInputDelimited_1[40]
									.trim();
						...
						if (41 < rowtFileInputDelimited_1.length) {
							row16.POFinancialAccount = rowtFileInputDelimited_1[41]
									.trim();
						...
						if (42 < rowtFileInputDelimited_1.length) {
							row16.Customer = rowtFileInputDelimited_1[42]
									.trim();
						...
						if (43 < rowtFileInputDelimited_1.length) {
							row16.CustomerPaymentMethod = rowtFileInputDelimited_1[43]
									.trim();
						...
						if (44 < rowtFileInputDelimited_1.length) {
							row16.PaymentTerm = rowtFileInputDelimited_1[44]
									.trim();
						...
						if (45 < rowtFileInputDelimited_1.length) {
							row16.PriceList = rowtFileInputDelimited_1[45]
									.trim();
						...
						if (46 < rowtFileInputDelimited_1.length) {
							row16.soTaxCategory = rowtFileInputDelimited_1[46]
									.trim();
						...
						if (47 < rowtFileInputDelimited_1.length) {
							row16.CustomerFinancialAccount = rowtFileInputDelimited_1[47]
									.trim();
						...
						if (48 < rowtFileInputDelimited_1.length) {
							row16.soInvoiceSchedule = rowtFileInputDelimited_1[48]
									.trim();
						...
						if (49 < rowtFileInputDelimited_1.length) {
							row16.soInvoicesTerms = rowtFileInputDelimited_1[49]
									.trim();
						...
						if (50 < rowtFileInputDelimited_1.length) {
							row16.Employee = rowtFileInputDelimited_1[50]
									.trim();
						...
						if (51 < rowtFileInputDelimited_1.length) {
							row16.IsSalesRepresentative = rowtFileInputDelimited_1[51]
									.trim();
				...
				if (row16 != null) {
					...
					org.openbravo.idl.proc.Validator validator = service
							.getValidator("Business Partner");

					row18.flag = "0";
					row18.whyError = "";

					row18.Organization = validator
							.checkOrganization(row16.Organization);

					row18.Searchkey = validator.checkNotNull(validator
							.checkString(row16.Searchkey, 40), "SearchKey");

					row18.Name = validator.checkNotNull(validator.checkString(
							row16.Name, 60), "Name");

					row18.Description = validator.checkString(
							row16.Description, 255);

					row18.TaxID = validator.checkString(row16.TaxID, 20,
							"TaxID");

					row18.TaxExempt = validator.checkBoolean(row16.TaxExempt);

					row18.ReferenceNo = validator.checkString(
							row16.ReferenceNo, 40);

					row18.Category = validator.checkNotNull(validator
							.checkString(row16.Category, 60, "Category"),
							"Category");

					row18.Language = validator.checkString(row16.Language, 6,
							"Language");

					row18.Adderss1stLine = validator.checkString(
							row16.Adderss1stLine, 60);

					row18.Address2ndLine = validator.checkString(
							row16.Address2ndLine, 60);

					row18.PostalCode = validator.checkString(row16.PostalCode,
							10);
					...
					row18.Country = validator.checkString(row16.Country, 60,
							"Country");

					row18.Phone = validator.checkString(row16.Phone, 40);

					row18.AlternativePhone = validator.checkString(
							row16.AlternativePhone, 40);

					row18.Fax = validator.checkString(row16.Fax, 40);

					row18.ShipToAddress = validator
							.checkBoolean(row16.ShipToAddress);

					row18.PayFromAddress = validator
							.checkBoolean(row16.PayFromAddress);

					row18.InvoiceToAddress = validator
							.checkBoolean(row16.InvoiceToAddress);

					row18.RemitToAddress = validator
							.checkBoolean(row16.RemitToAddress);

					row18.ConsumptionDays = validator
							.checkLong(row16.ConsumptionDays);

					row18.ShowGeneric = validator
							.checkBoolean(row16.ShowGeneric);

					row18.ShowIban = validator.checkBoolean(row16.ShowIban);

					row18.BankAccountNo = validator.checkString(
							row16.BankAccountNo, 20);

					row18.IBAN = validator.checkString(row16.IBAN, 34);

					row18.ContactUser = validator.checkString(
							row16.ContactUser, 60);

					row18.Firstname = validator
							.checkString(row16.Firstname, 60);

					row18.Lastname = validator.checkString(row16.Lastname, 60);

					row18.ContactDescription = validator.checkString(
							row16.ContactDescription, 255);

					row18.Email = validator.checkString(row16.Email, 255);

					row18.Position = validator.checkString(row16.Position, 40);

					row18.ContactPhone = validator.checkString(
							row16.ContactPhone, 40);

					row18.ContactAlternativePhone = validator.checkString(
							row16.ContactAlternativePhone, 40);

					row18.ContactFax = validator.checkString(row16.ContactFax,
							40);

					row18.Vendor = validator.checkNotNull(validator
							.checkBoolean(row16.Vendor, "Vendor"), "Vendor");

					row18.POPaymentMethod = validator.checkString(
							row16.POPaymentMethod, 60);

					row18.POPaymentTerms = validator.checkString(
							row16.POPaymentTerms, 40, "POPaymentTerm");

					row18.PurchasePriceList = validator.checkString(
							row16.PurchasePriceList, 60, "PurchasePriceList");

					row18.TaxCategory = validator.checkString(
							row16.TaxCategory, 60);

					row18.POFinancialAccount = validator.checkString(
							row16.POFinancialAccount, 60, "POFinancialAccount");

					row18.Customer = validator.checkNotNull(validator
							.checkBoolean(row16.Customer, "Customer"),
							"Customer");

					row18.CustomerPaymentMethod = validator.checkString(
							row16.CustomerPaymentMethod, 60);

					row18.PaymentTerm = validator.checkString(
							row16.PaymentTerm, 40, "PaymentTerm");

					row18.PriceList = validator.checkString(row16.PriceList,
							60, "SalePriceList");

					row18.soTaxCategory = validator.checkString(
							row16.soTaxCategory, 60);

					row18.CustomerFinancialAccount = validator.checkString(
							row16.CustomerFinancialAccount, 60,
							"SOFinancialAccount");

					row18.soInvoiceSchedule = validator.checkString(
							row16.soInvoiceSchedule, 60, "InvoiceSchedule");

					row18.soInvoicesTerms = validator.checkString(
							row16.soInvoicesTerms, 60, "InvoiceTerm");

					row18.Employee = validator.checkNotNull(validator
							.checkBoolean(row16.Employee, "Employee"),
							"Employee");

					row18.IsSalesRepresentative = validator.checkBoolean(
							row16.IsSalesRepresentative,
					...
					(row18.flag == null ? false : row18.flag.toLowerCase()
							.compareTo("0") == 0)
					...
					if (row1 != null) {
						...
						if (row1.Language != null) {
							Language objLang = service.findDALInstance(false,
									Language.class, new Value(
											Language.PROPERTY_LANGUAGE,
											row1.Language));
							if (objLang == null) {
								row2.flag = "-1";
								row2.whyError += service
						...
						if (row1.Country != null) {
							Country country = service.findDALInstance(false,
									Country.class, new Value("name",
											row1.Country));
							if (country == null) {
								row2.flag = "-1";
								row2.whyError += service
								...
								if (row1.Region != null) {
									Region region = service.findDALInstance(
											false, Region.class, new Value(
													"country", country),
											new Value("name", row1.Region));
									if (region == null) {
										row2.flag = "-1";
										row2.whyError += service
												.Utility_messageBD("IDL_BAD_REFERENCE")
						...
						if (row1.POPaymentTerms != null) {
							PaymentTerm objPOPaymentTermn = service
									.findDALInstance(false, PaymentTerm.class,
											new Value("searchKey",
													row1.POPaymentTerms));
						...
						if (row1.PurchasePriceList != null) {
							PriceList objPurchasePriceList = service
									.findDALInstance(false, PriceList.class,
											new Value("name",
													row1.PurchasePriceList),
											new Value("salesPriceList", false));
						...
						if (row1.TaxCategory != null) {
							TaxCategory objTaxCategory = service
									.findDALInstance(false, TaxCategory.class,
						...
						if (row1.POFinancialAccount != null) {
							FIN_FinancialAccount objFinancialAccount = service
									.findDALInstance(false,
						...
						if (row1.PaymentTerm != null) {
							PaymentTerm objPaymentTermn = service
									.findDALInstance(false, PaymentTerm.class,
											new Value("searchKey",
													row1.PaymentTerm));
						...
						if (row1.PriceList != null) {
							PriceList objPriceList = service.findDALInstance(
									false, PriceList.class, new Value("name",
											row1.PriceList), new Value(
											"salesPriceList", true));
						...
						if (row1.soTaxCategory != null) {
							TaxCategory objSoTaxCat = service.findDALInstance(
									false, TaxCategory.class, new Value("name",
											row1.soTaxCategory));
							if (objSoTaxCat == null) {
								row2.flag = "-1";
								row2.whyError += service
						...
						if (row1.soInvoiceSchedule != null) {
							InvoiceSchedule objInvoSche = service
									.findDALInstance(false,
											InvoiceSchedule.class, new Value(
													"name",
						...
						if (service.getReferenceValue("C_Order InvoiceRule",
						...
						if (row3 != null) {
							...
							service.finishRecordProcess(row3.Organization,
									row3.Searchkey, row3.Name,
									row3.Description, row3.TaxID,
									row3.TaxExempt, row3.ReferenceNo,
									row3.Category, row3.Language,
									row3.Adderss1stLine, row3.Address2ndLine,
									row3.PostalCode, row3.City, row3.Region,
									row3.Country, row3.Phone,
									row3.AlternativePhone, row3.Fax,
									row3.ShipToAddress, row3.PayFromAddress,
									row3.InvoiceToAddress, row3.RemitToAddress,
									row3.ConsumptionDays, row3.ShowGeneric,
									row3.ShowIban, row3.BankAccountNo,
									row3.IBAN, row3.ContactUser,
									row3.Firstname, row3.Lastname,
									row3.ContactDescription, row3.Email,
									row3.Position, row3.ContactPhone,
									row3.ContactAlternativePhone,
									row3.ContactFax, row3.Vendor,
									row3.POPaymentMethod, row3.POPaymentTerms,
									row3.PurchasePriceList, row3.TaxCategory,
									row3.POFinancialAccount, row3.Customer,
									row3.CustomerPaymentMethod,
									row3.PaymentTerm, row3.PriceList,
									row3.soTaxCategory,
									row3.CustomerFinancialAccount,
									row3.soInvoiceSchedule,
									row3.soInvoicesTerms, row3.Employee,
									row3.IsSalesRepresentative);
							nb_line_tJavaRow_18++;
						...
						if (row19 != null) {
							...
							service.logRecordError(row19.whyError,
									row19.Organization, row19.Searchkey,
									row19.Name, row19.Description, row19.TaxID,
									row19.TaxExempt, row19.ReferenceNo,
									row19.Category, row19.Language,
									row19.Adderss1stLine, row19.Address2ndLine,
									row19.PostalCode, row19.City, row19.Region,
									row19.Country, row19.Phone,
									row19.AlternativePhone, row19.Fax,
									row19.ShipToAddress, row19.PayFromAddress,
									row19.InvoiceToAddress,
									row19.RemitToAddress,
									row19.ConsumptionDays, row19.ShowGeneric,
									row19.ShowIban, row19.BankAccountNo,
									row19.IBAN, row19.ContactUser,
									row19.Firstname, row19.Lastname,
									row19.ContactDescription, row19.Email,
									row19.Position, row19.ContactPhone,
									row19.ContactAlternativePhone,
									row19.ContactFax, row19.Vendor,
									row19.POPaymentMethod,
									row19.POPaymentTerms,
									row19.PurchasePriceList, row19.TaxCategory,
									row19.POFinancialAccount, row19.Customer,
									row19.CustomerPaymentMethod,
									row19.PaymentTerm, row19.PriceList,
									row19.soTaxCategory,
									row19.CustomerFinancialAccount,
									row19.soInvoiceSchedule,
									row19.soInvoicesTerms, row19.Employee,
									row19.IsSalesRepresentative);
							nb_line_tJavaRow_9++;
					...
					if (row23 != null) {
						...
						service.logRecordError(row23.whyError,
								row23.Organization, row23.Searchkey,
								row23.Name, row23.Description, row23.TaxID,
								row23.TaxExempt, row23.ReferenceNo,
								row23.Category, row23.Language,
								row23.Adderss1stLine, row23.Address2ndLine,
								row23.PostalCode, row23.City, row23.Region,
								row23.Country, row23.Phone,
								row23.AlternativePhone, row23.Fax,
								row23.ShipToAddress, row23.PayFromAddress,
								row23.InvoiceToAddress, row23.RemitToAddress,
								row23.ConsumptionDays, row23.ShowGeneric,
								row23.ShowIban, row23.BankAccountNo,
								row23.IBAN, row23.ContactUser, row23.Firstname,
								row23.Lastname, row23.ContactDescription,
								row23.Email, row23.Position,
								row23.ContactPhone,
								row23.ContactAlternativePhone,
								row23.ContactFax, row23.Vendor,
								row23.POPaymentMethod, row23.POPaymentTerms,
								row23.PurchasePriceList, row23.TaxCategory,
								row23.POFinancialAccount, row23.Customer,
								row23.CustomerPaymentMethod, row23.PaymentTerm,
								row23.PriceList, row23.soTaxCategory,
								row23.CustomerFinancialAccount,
								row23.soInvoiceSchedule, row23.soInvoicesTerms,
								row23.Employee, row23.IsSalesRepresentative);
						nb_line_tJavaRow_16++;
			...
			globalMap.put("tFilterRow_10_NB_LINE_REJECT",
					nb_line_reject_tFilterRow_10);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			java.io.InputStream inContext = BusinessPartnerJob.class
					.getClassLoader()
					.getResourceAsStream(
			...
			if (contextStr.compareTo("Default") != 0) {
				inContext = BusinessPartnerJob.class.getClassLoader()
						.getResourceAsStream(
								"initial_data_load/businesspartnerjob_0_1/contexts/"
			...
			try {
				context.executeInsert = Boolean.parseBoolean(context
						.getProperty("executeInsert"));
			...
			try {
				context.numLinesOk = Integer.parseInt(context
						.getProperty("numLinesOk"));
			} catch (NumberFormatException e) {
				context.numLinesOk = null;
			}

			try {
				context.numLinesRejected = Integer.parseInt(context
						.getProperty("numLinesRejected"));
			} catch (NumberFormatException e) {
				context.numLinesRejected = null;
			}

			context.validationFailCause = (String) context
					.getProperty("validationFailCause");
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : BusinessPartnerJob");
		}
...
/************************************************************************************************
 * 506018 characters generated by Talend Open Studio on the 2 de febrero de 2012
 * 13:16:11 CET
 ************************************************************************************************/
