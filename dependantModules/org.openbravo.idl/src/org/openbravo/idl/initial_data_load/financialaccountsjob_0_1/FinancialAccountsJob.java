...
public class FinancialAccountsJob {
	...
	private final String jobName = "FinancialAccountsJob";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(FinancialAccountsJob.this, new Object[] {
									e, globalMap });
							break;
						}
					}
			...
			synchronized (commonByteArrayLock) {
				...
				try {
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.Location1stLine = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.Location2ndLine = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.LocationPostalCode = new String(commonByteArray,
								0, length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.LocationCity = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.LocationRegion = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.LocationCountry = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.BankControlDigit = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.AccountControlDigit = new String(commonByteArray,
								0, length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.PartialAccountNo = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.InitialBalance = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.CreditLimit = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.MatchingAlgorithm = new String(commonByteArray, 0,
								length);
					}
			...
			while (limittFileInputDelimited_1 != 0
				...
				try {
					...
					if (rowtFileInputDelimited_1.length == 1
						...
						if (2 < rowtFileInputDelimited_1.length) {
							row1.Description = rowtFileInputDelimited_1[2]
									.trim();
						...
						if (6 < rowtFileInputDelimited_1.length) {
							row1.BusinessPartner = rowtFileInputDelimited_1[6]
									.trim();
						...
						if (7 < rowtFileInputDelimited_1.length) {
							row1.Location1stLine = rowtFileInputDelimited_1[7]
									.trim();
						...
						if (8 < rowtFileInputDelimited_1.length) {
							row1.Location2ndLine = rowtFileInputDelimited_1[8]
									.trim();
						...
						if (9 < rowtFileInputDelimited_1.length) {
							row1.LocationPostalCode = rowtFileInputDelimited_1[9]
									.trim();
						...
						if (10 < rowtFileInputDelimited_1.length) {
							row1.LocationCity = rowtFileInputDelimited_1[10]
									.trim();
						...
						if (11 < rowtFileInputDelimited_1.length) {
							row1.LocationRegion = rowtFileInputDelimited_1[11]
									.trim();
						...
						if (12 < rowtFileInputDelimited_1.length) {
							row1.LocationCountry = rowtFileInputDelimited_1[12]
									.trim();
						...
						if (14 < rowtFileInputDelimited_1.length) {
							row1.BranchCode = rowtFileInputDelimited_1[14]
									.trim();
						...
						if (15 < rowtFileInputDelimited_1.length) {
							row1.BankControlDigit = rowtFileInputDelimited_1[15]
									.trim();
						...
						if (17 < rowtFileInputDelimited_1.length) {
							row1.SwiftCode = rowtFileInputDelimited_1[17]
									.trim();
						...
						if (18 < rowtFileInputDelimited_1.length) {
							row1.AccountControlDigit = rowtFileInputDelimited_1[18]
									.trim();
						...
						if (19 < rowtFileInputDelimited_1.length) {
							row1.PartialAccountNo = rowtFileInputDelimited_1[19]
									.trim();
						...
						if (20 < rowtFileInputDelimited_1.length) {
							row1.AccountNo = rowtFileInputDelimited_1[20]
									.trim();
						...
						if (22 < rowtFileInputDelimited_1.length) {
							row1.InitialBalance = rowtFileInputDelimited_1[22]
									.trim();
						...
						if (23 < rowtFileInputDelimited_1.length) {
							row1.CreditLimit = rowtFileInputDelimited_1[23]
									.trim();
						...
						if (24 < rowtFileInputDelimited_1.length) {
							row1.MatchingAlgorithm = rowtFileInputDelimited_1[24]
									.trim();
				...
				if (row1 != null) {
					...
					org.openbravo.idl.proc.Validator validator = service
							.getValidator("Financial Account");
					...
					row2.IsDefault = validator.checkBoolean(row1.IsDefault,
							"IsDefault");
					row2.BusinessPartner = validator.checkString(
							row1.BusinessPartner, 60);
					row2.Location1stLine = validator.checkString(
							row1.Location1stLine, 60);
					row2.Location2ndLine = validator.checkString(
							row1.Location2ndLine, 60);
					row2.LocationPostalCode = validator.checkString(
							row1.LocationPostalCode, 10);
					row2.LocationCity = validator.checkString(
							row1.LocationCity, 60);
					row2.LocationRegion = validator.checkString(
							row1.LocationRegion, 60);
					row2.LocationCountry = validator.checkString(
							row1.LocationCountry, 60);
					row2.BankCode = validator.checkString(row1.BankCode, 4);
					row2.BranchCode = validator.checkString(row1.BranchCode, 4);
					row2.BankControlDigit = validator.checkString(
							row1.BankControlDigit, 1);
					row2.INENo = validator.checkString(row1.INENo, 9);
					row2.SwiftCode = validator.checkString(row1.SwiftCode, 20);
					row2.AccountControlDigit = validator.checkString(
							row1.AccountControlDigit, 1);
					row2.PartialAccountNo = validator.checkString(
							row1.PartialAccountNo, 10);
					row2.AccountNo = validator.checkString(row1.AccountNo, 50);
					row2.IBAN = validator.checkString(row1.IBAN, 34);
					row2.InitialBalance = validator
							.checkBigDecimal(row1.InitialBalance);
					row2.CreditLimit = validator
							.checkBigDecimal(row1.CreditLimit);
					row2.MatchingAlgorithm = validator.checkString(
							row1.MatchingAlgorithm, 60);
					...
					if (row4 != null) {
						...
						row6.Type = row4.Type;
						if (row4.Type != null) {
							if (service.getReferenceValue(
									"Financial account type", row4.Type) == null) {
								row6.flag = "-1";
								row6.whyError += service
										.Utility_messageBD("IDL_BAD_REFERENCE")
										+ row4.Type + "\n";
						...
						if (row4.LocationCountry != null
								&& row4.LocationRegion != null) {
							...
							if (country == null) {
								...
								Region region = service.findDALInstance(false,
										Region.class, new Value("country",
						...
						if (row4.MatchingAlgorithm != null) {
							MatchingAlgorithm ma = service.findDALInstance(
									false, MatchingAlgorithm.class, new Value(
											MatchingAlgorithm.PROPERTY_NAME,
						...
						if (row7 != null) {
							...
							service.finishRecordProcess(row7.Organization,
									row7.Name, row7.Description, row7.Currency,
									row7.Type, row7.IsDefault,
									row7.BusinessPartner, row7.Location1stLine,
									row7.Location2ndLine,
									row7.LocationPostalCode, row7.LocationCity,
									row7.LocationRegion, row7.LocationCountry,
									row7.BankCode, row7.BranchCode,
									row7.BankControlDigit, row7.INENo,
									row7.SwiftCode, row7.AccountControlDigit,
									row7.PartialAccountNo, row7.AccountNo,
									row7.IBAN, row7.InitialBalance,
									row7.CreditLimit, row7.MatchingAlgorithm);
						...
						if (row5 != null) {
							...
							service.logRecordError(row5.whyError,
									row5.Organization, row5.Name,
									row5.Description, row5.Currency, row5.Type,
									row5.IsDefault, row5.BusinessPartner,
									row5.Location1stLine, row5.Location2ndLine,
									row5.LocationPostalCode, row5.LocationCity,
									row5.LocationRegion, row5.LocationCountry,
									row5.BankCode, row5.BranchCode,
									row5.BankControlDigit, row5.INENo,
									row5.SwiftCode, row5.AccountControlDigit,
									row5.PartialAccountNo, row5.AccountNo,
									row5.IBAN, row5.InitialBalance,
									row5.CreditLimit, row5.MatchingAlgorithm);
					...
					if (row3 != null) {
						...
						service.logRecordError(row3.whyError,
								row3.Organization, row3.Name, row3.Description,
								row3.Currency, row3.Type, row3.IsDefault,
								row3.BusinessPartner, row3.Location1stLine,
								row3.Location2ndLine, row3.LocationPostalCode,
								row3.LocationCity, row3.LocationRegion,
								row3.LocationCountry, row3.BankCode,
								row3.BranchCode, row3.BankControlDigit,
								row3.INENo, row3.SwiftCode,
								row3.AccountControlDigit,
								row3.PartialAccountNo, row3.AccountNo,
								row3.IBAN, row3.InitialBalance,
								row3.CreditLimit, row3.MatchingAlgorithm);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			java.io.InputStream inContext = FinancialAccountsJob.class
					.getClassLoader()
					.getResourceAsStream(
			...
			if (contextStr.compareTo("Default") != 0) {
				inContext = FinancialAccountsJob.class.getClassLoader()
						.getResourceAsStream(
								"initial_data_load/financialaccountsjob_0_1/contexts/"
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : FinancialAccountsJob");
		}
...
/************************************************************************************************
 * 273137 characters generated by Talend Open Studio on the July 9, 2010
 * 12:12:36 PM CEST
 ************************************************************************************************/
