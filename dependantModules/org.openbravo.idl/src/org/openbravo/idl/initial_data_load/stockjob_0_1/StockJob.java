...
public class StockJob {
	...
	private final String jobName = "StockJob";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(StockJob.this,
									new Object[] { e, globalMap });
							break;
						}
					}
	...
	public void tFilterRow_3_error(Exception exception,
			final java.util.Map<String, Object> globalMap)
			throws TalendException {
			...
			synchronized (commonByteArrayLock) {
				...
				try {
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.TransactionalOrganization = new String(
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.MovementDate = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.WarehouseName = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.WarehouseDescription = new String(commonByteArray,
								0, length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.Warehouse1stLine = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.Warehouse2ndLine = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.WarehousePostalCode = new String(commonByteArray,
								0, length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.WarehouseCity = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.WarehouseRegion = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.WarehouseCountry = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.WarehouseBinSeparator = new String(
								commonByteArray, 0, length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.BinIsDefault = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.BinPriority = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.AttributeValue = new String(commonByteArray, 0,
								length);
					}
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				if (this.TransactionalOrganization == null) {
					...
					byte[] byteArray = this.TransactionalOrganization
							.getBytes();
					dos.writeInt(byteArray.length);
					dos.write(byteArray);
				}
	...
	static class row11Struct implements
		...
		try {
			...
			while (limittFileInputDelimited_1 != 0
				...
				if (row1 != null) {
					...
					row2.Name = validator.checkNotNull(validator.checkString(
							row1.Name, 60), "Name");
					row2.Description = validator.checkString(row1.Description,
							255, "Description");
					row2.MovementDate = validator.checkNotNull(validator
							.checkDate(row1.MovementDate, "MovementDate"),
							"MovementDate");
					row2.Warehouse = validator.checkNotNull(validator
							.checkString(row1.Warehouse, 60, "Warehouse"),
							"Warehouse");
					row2.WarehouseName = validator.checkNotNull(validator
							.checkString(row1.WarehouseName, 60,
									"WarehouseName"), "WarehouseName");
					row2.WarehouseDescription = validator.checkString(
							row1.WarehouseDescription, 255,
							"WarehouseDescription");
					row2.Warehouse1stLine = validator.checkString(
							row1.Warehouse1stLine, 60);
					row2.Warehouse2ndLine = validator.checkString(
							row1.Warehouse2ndLine, 60);
					row2.WarehousePostalCode = validator.checkString(
							row1.WarehousePostalCode, 10);
					row2.WarehouseCity = validator.checkString(
							row1.WarehouseCity, 60);
					row2.WarehouseRegion = validator.checkString(
							row1.WarehouseRegion, 60);
					row2.WarehouseCountry = validator.checkString(
							row1.WarehouseCountry, 60, "WarehouseCountry");
					row2.WarehouseBinSeparator = validator.checkString(
							row1.WarehouseBinSeparator, 1,
							"WarehouseBinSeparator");
					row2.Bin = validator.checkNotNull(validator.checkString(
							row1.Bin, 40, "Bin"), "Bin");
					row2.BinIsDefault = validator.checkNotNull(validator
							.checkBoolean(row1.BinIsDefault, "BinIsDefault"),
							"BinIsDefault");
					row2.BinPriority = validator.checkNotNull(validator
							.checkLong(row1.BinPriority, "BinPriority"),
							"BinPriority");
					row2.BinRowX = validator.checkString(row1.BinRowX, 60,
							"BinRowX");
					row2.BinStackY = validator.checkString(row1.BinStackY, 60,
							"BinStackY");
					row2.BinLevelZ = validator.checkString(row1.BinLevelZ, 60,
							"BinLevelZ");
					row2.Product = validator.checkNotNull(validator
							.checkString(row1.Product, 40), "Product");
					row2.AttributeValue = validator.checkString(
							row1.AttributeValue, 60);
					row2.Quantity = validator.checkNotNull(validator
							.checkBigDecimal(row1.Quantity), "Quantity");
					...
					if (row4 != null) {
						...
						Product product = service.findDALInstance(true,
								Product.class, new Value(
										Product.PROPERTY_SEARCHKEY,
										row4.Product));
						...
						(row7.flag == null ? false : row7.flag.toLowerCase()
								.compareTo("0") == 0)
						...
						if (row9 != null) {
							...
							Country country = service.findDALInstance(true,
									Country.class, new Value("name",
											row9.WarehouseCountry));
							row10.flag = country == null
									&& row9.WarehouseCountry != null
									&& !row9.WarehouseCountry.equals("") ? "-1"
									: "0";
							...
							(row10.flag == null ? false : row10.flag
							...
							if (row12 != null) {
								...
								service3.finishRecordProcess(
										row12.Organization,
										row12.TransactionalOrganization,
										row12.Name, row12.Description,
										row12.MovementDate, row12.Warehouse,
										row12.WarehouseName,
										row12.WarehouseDescription,
										row12.Warehouse1stLine,
										row12.Warehouse2ndLine,
										row12.WarehousePostalCode,
										row12.WarehouseCity,
										row12.WarehouseRegion,
										row12.WarehouseCountry,
										row12.WarehouseBinSeparator, row12.Bin,
										row12.BinIsDefault, row12.BinPriority,
										row12.BinRowX, row12.BinStackY,
										row12.BinLevelZ, row12.Product,
										row12.AttributeValue, row12.Quantity,
										row12.Cost);
							...
							if (row11 != null) {
								...
								service8.logRecordError(service8
										.Utility_messageBD("IDL_BAD_REFERENCE")
										+ row11.WarehouseCountry,
										row11.Organization,
										row11.TransactionalOrganization,
										row11.Name, row11.Description,
										row11.MovementDate, row11.Warehouse,
										row11.WarehouseName,
										row11.WarehouseDescription,
										row11.Warehouse1stLine,
										row11.Warehouse2ndLine,
										row11.WarehousePostalCode,
										row11.WarehouseCity,
										row11.WarehouseRegion,
										row11.WarehouseCountry,
										row11.WarehouseBinSeparator, row11.Bin,
										row11.BinIsDefault, row11.BinPriority,
										row11.BinRowX, row11.BinStackY,
										row11.BinLevelZ, row11.Product,
										row11.AttributeValue, row11.Quantity,
										row11.Cost);
						...
						if (row8 != null) {
							...
							service6.logRecordError(service6
									.Utility_messageBD("IDL_BAD_REFERENCE")
									+ row8.Product, row8.Organization,
									row8.TransactionalOrganization, row8.Name,
									row8.Description, row8.MovementDate,
									row8.Warehouse, row8.WarehouseName,
									row8.WarehouseDescription,
									row8.Warehouse1stLine,
									row8.Warehouse2ndLine,
									row8.WarehousePostalCode,
									row8.WarehouseCity, row8.WarehouseRegion,
									row8.WarehouseCountry,
									row8.WarehouseBinSeparator, row8.Bin,
									row8.BinIsDefault, row8.BinPriority,
									row8.BinRowX, row8.BinStackY,
									row8.BinLevelZ, row8.Product,
									row8.AttributeValue, row8.Quantity,
									row8.Cost);
					...
					if (row3 != null) {
						...
						service2.logRecordError(row3.whyError,
								row3.Organization,
								row3.TransactionalOrganization, row3.Name,
								row3.Description, row3.MovementDate,
								row3.Warehouse, row3.WarehouseName,
								row3.WarehouseDescription,
								row3.Warehouse1stLine, row3.Warehouse2ndLine,
								row3.WarehousePostalCode, row3.WarehouseCity,
								row3.WarehouseRegion, row3.WarehouseCountry,
								row3.WarehouseBinSeparator, row3.Bin,
								row3.BinIsDefault, row3.BinPriority,
								row3.BinRowX, row3.BinStackY, row3.BinLevelZ,
								row3.Product, row3.AttributeValue,
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			java.io.InputStream inContext = StockJob.class
					.getClassLoader()
					.getResourceAsStream(
			...
			if (contextStr.compareTo("Default") != 0) {
				inContext = StockJob.class.getClassLoader()
						.getResourceAsStream(
								"initial_data_load/stockjob_0_1/contexts/"
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : StockJob");
		}
...
/************************************************************************************************
 * 355656 characters generated by Talend Open Studio on the April 11, 2013
 * 1:52:21 PM CEST
 ************************************************************************************************/
