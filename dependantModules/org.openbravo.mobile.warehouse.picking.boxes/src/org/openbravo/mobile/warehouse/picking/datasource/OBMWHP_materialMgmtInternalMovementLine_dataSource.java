...
public class OBMWHP_materialMgmtInternalMovementLine_dataSource extends WarehouseProcessHQLQuery {
  public static final String movementLinesExtension = "OBMWHP_movementLinesExtension";

  @Inject
  @Any
  @Qualifier(movementLinesExtension)
  ...
  protected List<String> getQuery(JSONObject jsonsent) throws JSONException {
    ...
    HQLPropertyList regularMovementLineProperties = ModelExtensionUtils
        .getPropertyExtensions(extensions);

    StringBuilder strBuild = new StringBuilder();
    strBuild.append("select ");
    strBuild.append(regularMovementLineProperties.getHqlSelect());
    strBuild
        .append("from MaterialMgmtInternalMovementLine as movLine left outer join movLine.product as prd left outer join movLine.salesOrderLine as sol ");
    ...
    strBuild
        .append("order by movLine.storageBin.rowX ASC, movLine.storageBin.stackY ASC, movLine.storageBin.levelZ ASC, sol.salesOrder.orderDate ASC ");
