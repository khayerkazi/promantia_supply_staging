 ...
 ************************************************************************
 */
package com.sysfore.fastnslowmovingrpt.info ;
...
public class BrandMultiple extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;

  private static final String[] colNames = { "Name", "Description", "Cl_Brand_ID",
      "RowKey" };
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      // vars.setSessionValue("BrandMultiple.name", strNameValue + "%");
      //String strKeyValue = vars.getGlobalVariable("inpKey", "BrandMultiple.key", "");
      String strNameValue = vars.getGlobalVariable("inpName", "BrandMultiple.name", "");
      ...
      if (vars.getStringParameter("clear").equals("true")) {
       // vars.removeSessionValue("BrandMultiple.key");
        vars.removeSessionValue("BrandMultiple.name");
        vars.removeSessionValue("BrandMultiple.adorgid");
      }
     // String strKey = vars.getGlobalVariable("inpKey", "BrandMultiple.key", "");
      String strName = vars.getGlobalVariable("inpName", "BrandMultiple.name", "");
      String strOrg = vars.getGlobalVariable("inpAD_Org_ID", "BrandMultiple.adorgid", "");
      ...
      if (action.equalsIgnoreCase("getRows")) { // Asking for data rows
        printGridData(response, vars,  strName, strOrg, strSortCols, strSortDirs, strOffset, strPageSize, strNewFilter);
      } else if (action.equalsIgnoreCase("getIdsInRange")) {
        // asking for selected rows
        printGridDataSelectedRows(response, vars,  strName,  strOrg, strSortCols, strSortDirs);
      } else {
  ...
  private void PrintPage(HttpServletResponse response, VariablesSecureApp vars,
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
        "com/sysfore/fastnslowmovingrpt/info/BrandMultiple").createXmlDocument();
    if (strNameValue.equals("")) {
    ...
    if (headers != null) {
      try {
        ...
        if (strNewFilter.equals("1") || strNewFilter.equals("")) { // New
          ...
          strNumRows = BrandData.countRows(this,rownum,  strName, Utility.getContext(this, vars, "#User_Client", "BrandMultiple"), Utility
                  .getSelectorOrgs(this, vars, strOrg),pgLimit, oraLimit1, oraLimit2);
          vars.setSessionValue("BrandMultiple.numrows", strNumRows);
          System.out.println("strNumRows======" +strNumRows);
        } else {
          strNumRows = vars.getSessionValue("BrandMultiple.numrows");
            System.out.println("strNumRows111111111111======" +strNumRows);
        }
        ...
        if (this.myPool.getRDBMS().equalsIgnoreCase("ORACLE")) {
          ...
          data = BrandData.select(myPool, "ROWNUM", description, strOrg, type, strOrderBy, "", oraLimit2, oraLimit2);


                  //select(this, "ROWNUM",  strName, Utility.getContext(this, vars, "#User_Client", "BrandMultiple"), Utility
                 // .getSelectorOrgs(this, vars, strOrg), strOrderBy, "", oraLimit1, oraLimit2);
        } else {
          String pgLimit = pageSize + " OFFSET " + offset;
          data = BrandData.select(this, "1",  strName, Utility.getContext(this, vars, "#User_Client", "BrandMultiple"), Utility.getSelectorOrgs(
  ...
  private void printGridDataSelectedRows(HttpServletResponse response, VariablesSecureApp vars,
      String strName, String strOrg, String strOrderCols, String strOrderDirs) throws IOException, ServletException {
    ...
    try {
      ...
      if (this.myPool.getRDBMS().equalsIgnoreCase("ORACLE")) {
        ...
        data = BrandData.select(myPool, "ROWNUM",  strName, Utility.getContext(this, vars, "#User_Client", "BrandMultiple"),Utility
                .getSelectorOrgs(this, vars, strOrg), strOrderBy, "", oraLimit2, oraLimit2);
