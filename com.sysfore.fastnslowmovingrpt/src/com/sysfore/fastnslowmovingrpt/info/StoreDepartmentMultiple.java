...
//import com.sysfore.fastnslowmovingrpt.info.*;
...
public class StoreDepartmentMultiple extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;

  private static final String[] colNames = { "Name", "Description", "Cl_Department_ID",
      "RowKey" };
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      // "DepartmentMultiple.name");
      // if (!strNameValue.equals(""))
      // vars.setSessionValue("DepartmentMultiple.name", strNameValue + "%");
      //String strKeyValue = vars.getGlobalVariable("inpKey", "DepartmentMultiple.key", "");
      String strNameValue = vars.getGlobalVariable("inpName", "StoreDepartmentMultiple.name", "");
      ...
      if (vars.getStringParameter("clear").equals("true")) {
       // vars.removeSessionValue("DepartmentMultiple.key");
        vars.removeSessionValue("StoreDepartmentMultiple.name");
        vars.removeSessionValue("StoreDepartmentMultiple.adorgid");
      }
     // String strKey = vars.getGlobalVariable("inpKey", "DepartmentMultiple.key", "");
      String strName = vars.getGlobalVariable("inpName", "StoreDepartmentMultiple.name", "");
      String strOrg = vars.getGlobalVariable("inpAD_Org_ID", "StoreDepartmentMultiple.adorgid", "");
  ...
  private void PrintPage(HttpServletResponse response, VariablesSecureApp vars,
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
        "com/sysfore/fastnslowmovingrpt/info/StoreDepartmentMultiple").createXmlDocument();
    if (strNameValue.equals("")) {
    ...
    if (headers != null) {
      try {
        ...
        if (strNewFilter.equals("1") || strNewFilter.equals("")) { // New
          ...
          strNumRows = StoredepartmentData.countRows(this,rownum,  strName, Utility.getContext(this, vars, "#User_Client", "BrandMultiple"), Utility
        ...
        if (this.myPool.getRDBMS().equalsIgnoreCase("ORACLE")) {
          ...
          data = StoredepartmentData.select(myPool, "ROWNUM", description, strOrg, type, strOrderBy, "", oraLimit2, oraLimit2);


                  //select(this, "ROWNUM",  strName, Utility.getContext(this, vars, "#User_Client", "DepartmentMultiple"), Utility
                 // .getSelectorOrgs(this, vars, strOrg), strOrderBy, "", oraLimit1, oraLimit2);
        } else {
          String pgLimit = pageSize + " OFFSET " + offset;
          data = StoredepartmentData.select(this, "1",  strName, Utility.getContext(this, vars, "#User_Client", "StoreDepartmentMultiple"), Utility.getSelectorOrgs(
  ...
  private void printGridDataSelectedRows(HttpServletResponse response, VariablesSecureApp vars,
    ...
    try {
      ...
      if (this.myPool.getRDBMS().equalsIgnoreCase("ORACLE")) {
        ...
        data = StoredepartmentData.select(myPool, "ROWNUM",  strName, Utility.getContext(this, vars, "#User_Client", "StoreDepartmentMultiple"),Utility
