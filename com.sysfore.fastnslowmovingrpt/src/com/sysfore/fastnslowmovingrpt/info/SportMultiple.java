...
public class SportMultiple extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;

  private static final String[] colNames = { "Name", "Description", "Cl_Sport_ID",
      "RowKey" };
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      // vars.setSessionValue("SportMultiple.name", strNameValue + "%");
      //String strKeyValue = vars.getGlobalVariable("inpKey", "SportMultiple.key", "");
      String strNameValue = vars.getGlobalVariable("inpName", "SportMultiple.name", "");
      ...
      if (vars.getStringParameter("clear").equals("true")) {
       // vars.removeSessionValue("SportMultiple.key");
        vars.removeSessionValue("SportMultiple.name");
        vars.removeSessionValue("SportMultiple.adorgid");
      }
     // String strKey = vars.getGlobalVariable("inpKey", "SportMultiple.key", "");
      String strName = vars.getGlobalVariable("inpName", "SportMultiple.name", "");
      String strOrg = vars.getGlobalVariable("inpAD_Org_ID", "SportMultiple.adorgid", "");
  ...
  private void PrintPage(HttpServletResponse response, VariablesSecureApp vars,
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
        "com/sysfore/fastnslowmovingrpt/info/SportMultiple").createXmlDocument();
    if (strNameValue.equals("")) {
    ...
    if (headers != null) {
      try {
        ...
        if (strNewFilter.equals("1") || strNewFilter.equals("")) { // New
          ...
          strNumRows = SportData.countRows(this,rownum,  strName, Utility.getContext(this, vars, "#User_Client", "SportMultiple"), Utility
        ...
        if (this.myPool.getRDBMS().equalsIgnoreCase("ORACLE")) {
          ...
          data = SportData.select(myPool, "ROWNUM", description, strOrg, type, strOrderBy, "", oraLimit2, oraLimit2);


                  //select(this, "ROWNUM",  strName, Utility.getContext(this, vars, "#User_Client", "SportMultiple"), Utility
                 // .getSelectorOrgs(this, vars, strOrg), strOrderBy, "", oraLimit1, oraLimit2);
        } else {
          String pgLimit = pageSize + " OFFSET " + offset;
          data = SportData.select(this, "1",  strName, Utility.getContext(this, vars, "#User_Client", "SportMultiple"), Utility.getSelectorOrgs(
  ...
  private void printGridDataSelectedRows(HttpServletResponse response, VariablesSecureApp vars,
    ...
    try {
      ...
      if (this.myPool.getRDBMS().equalsIgnoreCase("ORACLE")) {
        ...
        data = SportData.select(myPool, "ROWNUM",  strName, Utility.getContext(this, vars, "#User_Client", "SportMultiple"),Utility
