...
public class DepartmentMultiple extends HttpSecureAppServlet {
  ...
  private void PrintPage(HttpServletResponse response, VariablesSecureApp vars,
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
        "com/sysfore/fastnslowmovingrpt/info/DepartmentMultiple").createXmlDocument();
    if (strNameValue.equals("")) {
    ...
    if (headers != null) {
      try {
        ...
        if (strNewFilter.equals("1") || strNewFilter.equals("")) { // New
          ...
          strNumRows = DepartmentData.countRows(this,rownum,  strName, Utility.getContext(this, vars, "#User_Client", "BrandMultiple"), Utility
        ...
        if (this.myPool.getRDBMS().equalsIgnoreCase("ORACLE")) {
          ...
          data = DepartmentData.select(myPool, "ROWNUM", description, strOrg, type, strOrderBy, "", oraLimit2, oraLimit2);
          ...
          data = DepartmentData.select(this, "1",  strName, Utility.getContext(this, vars, "#User_Client", "DepartmentMultiple"), Utility.getSelectorOrgs(
  ...
  private void printGridDataSelectedRows(HttpServletResponse response, VariablesSecureApp vars,
    ...
    try {
      ...
      if (this.myPool.getRDBMS().equalsIgnoreCase("ORACLE")) {
        ...
        data = DepartmentData.select(myPool, "ROWNUM",  strName, Utility.getContext(this, vars, "#User_Client", "DepartmentMultiple"),Utility
