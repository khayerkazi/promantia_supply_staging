isc.defineClass('ECOMPickValidateProcessNew', isc.VLayout);

isc.ECOMPickValidateProcessNew.addProperties({
	width: '100%',
	  height: '100%',
	  overflow: 'auto',
	  autoSize: false,
	...
	stringHTML = "<div id='invoice_anvesh' style='width:100%;height:100%;clear:both;border:2px solid #000;'>" +
					"<div style='width:100%;height:50px;clear:both;border-bottom:1px solid #000;'>" +
						"<div style='width:30%;height:50px;float:left;text-align:left;line-height:50px;'><img src='"+this.pickGridData.logourl+"' /></div>" +
					...
					"<div style='width:100%;height:180px;border-bottom:1px solid #000;clear:both;'>" +
						...
						"<table style='cellspacing:0px;cellpadding:0px;width:50%;float:left;height:180px;'>" +
							...
							"<tr><td style='width:100%;height:15px;font-size:11px;line-height:14px;text-align:left;'>&nbsp;&nbsp;&nbsp;Invoice Number <strong>"+this.pickGridData.invoiceNum+"</strong></td></tr>" +
							"<tr><td style='width:100%;height:15px;font-size:11px;line-height:14px;text-align:left;'>&nbsp;&nbsp;&nbsp;Order ID <strong>"+this.pickGridData.orderId+"</strong></td></tr>" +
							"<tr><td rowspan='3' style='width:100%;height:50px;line-height:14px;text-align:left;'>&nbsp;&nbsp;&nbsp;<img src='http://www.barcodesinc.com/generator/image.php?code="+this.pickGridData.invoiceNum+"&style=197&type=C128B&width=170&height=50&xres=1&font=6'/></td></tr>" +
							...
							"<tr><td style='width:100%;height:15px;font-size:11px;line-height:14px;text-align:left;'>&nbsp;&nbsp;&nbsp;Invoice Date <strong>"+this.pickGridData.orderDate+"</strong></td></tr>" +
					...
					"<div style='width:100%;clear:both;'>" +
						"<table cellspacing='0' cellpadding='0' border='0'>" +
							...
							"<tr>" +
								...
								"<td style='width:3%;height:24px;line-height:15px;text-align:center;font-size:11px;border-right:1px solid #000;border-bottom:1px solid #000;'>"+this.pickGridData.totalInvQty+"</td>" +
								...
								"<td style='width:10%;height:24px;line-height:15px;text-align:center;font-size:11px;border-right:1px solid #000;border-bottom:1px solid #000;'>&nbsp;</td>" +
								"<td style='width:10%;height:24px;line-height:15px;text-align:center;font-size:11px;border-right:1px solid #000;border-bottom:1px solid #000;'>&nbsp;</td>" +
								"<td style='width:10%;height:24px;line-height:15px;text-align:center;font-size:11px;border-right:1px solid #000;border-bottom:1px solid #000;'>"+this.pickGridData.subTotal+"</td>" +
							"</tr>" +
							"<tr>" +
								"<td style='width:15%;height:24px;line-height:15px;text-align:center;font-size:11px;border-right:1px solid #000;border-bottom:1px solid #000;'>&nbsp;</td>" +
								"<td style='width:5%;height:24px;line-height:15px;text-align:center;font-size:11px;border-right:1px solid #000;border-bottom:1px solid #000;'>&nbsp;</td>" +
								...
								"<td style='width:10%;height:24px;line-height:15px;text-align:center;font-size:11px;border-right:1px solid #000;border-bottom:1px solid #000;'>&nbsp;</td>" +
								"<td style='width:10%;height:24px;line-height:15px;text-align:center;font-size:11px;border-right:1px solid #000;border-bottom:1px solid #000;'>&nbsp;</td>" +
								"<td style='width:10%;height:24px;line-height:15px;text-align:center;font-size:11px;border-right:1px solid #000;border-bottom:1px solid #000;'>"+this.pickGridData.shipTotal+"</td>" +
							"</tr>" +
							"<tr>" +
								...
								"<td style='width:10%;height:24px;line-height:15px;text-align:center;font-size:11px;border-right:1px solid #000;border-bottom:1px solid #000;'>&nbsp;</td>" +
								"<td style='width:10%;height:24px;line-height:15px;text-align:center;font-size:11px;border-right:1px solid #000;border-bottom:1px solid #000;'>&nbsp;</td>" +
								"<td style='width:10%;height:24px;line-height:15px;text-align:center;font-size:11px;border-right:1px solid #000;border-bottom:1px solid #000;'>"+this.pickGridData.invTotal+"</td>" +
							"</tr>" +
						"</table>" +
					"</div>" +
//					"<div style='width:100%;height:15px;clear:both;'>&nbsp;</div>" +
//					"<div style='width:70%;height:25px;line-height:15px;font-size:11px;text-align:right;float:left;font-weight:bold;'>Sub Total&nbsp;&nbsp;</div><div style='width:30%;height:25px;line-height:15px;text-align:center;float:left;font-size:11px;'>Rs.&nbsp;"+this.pickGridData.subTotal+"</div>" +
//					"<div style='width:70%;height:25px;line-height:15px;font-size:11px;text-align:right;float:left;font-weight:bold;'>Delivery charges for items @ 5.5 %&nbsp;&nbsp;</div><div style='width:30%;height:25px;line-height:15px;text-align:center;float:left;font-size:11px;'>Rs.&nbsp;"+this.pickGridData.tax5+"</div>" +
//					"<div style='width:70%;height:25px;line-height:15px;font-size:11px;text-align:right;float:left;font-weight:bold;'>Delivery charges for items @ 14.5 %&nbsp;&nbsp;</div><div style='width:30%;height:25px;line-height:15px;text-align:center;float:left;font-size:11px;'>Rs.&nbsp;"+this.pickGridData.tax14+"</div>" +
//					"<div style='width:70%;height:25px;line-height:15px;font-size:11px;text-align:right;float:left;font-weight:bold;'>Delivery Charges Paid&nbsp;&nbsp;</div><div style='width:30%;height:25px;line-height:15px;text-align:center;float:left;font-size:11px;'>Rs.&nbsp;"+this.pickGridData.shipTotal+"</div>" +
//					"<div style='width:70%;height:25px;line-height:15px;font-size:11px;tet-align:right;float:left;font-weight:bold;'>Invoice Total&nbsp;&nbsp;</div><div style='width:30%;height:25px;line-height:15px;text-align:center;float:left;font-size:11px;'>Rs.&nbsp;"+this.pickGridData.invTotal+"</div>
					"<div style='width:100%;height:24px;clear:both;border-bottom:1px solid #000;'>" +
						...
						"<div style='width:50%;float:left;height:24px;line-height:24px;text-align:center;font-size:11px;'>&nbsp;Place and date of issue&nbsp;&nbsp;:&nbsp;&nbsp;Bangalore,&nbsp;"+this.pickGridData.dateOfIssue+"</div>" +
					"</div>" +
					...
					"<div style='width:100%;height:90px;clear:both;'>" +
						...
						"</div>" +
					"</div>" +
//					"<div style='width:49.5%;height:45px;float:left;border-left:1px solid #000;border-bottom:1px solid #000;border-top:1px solid #000;'>&nbsp;</div><div style='width:49.4%;height:45px;border:1px solid #000;float:left;text-align:center;font-weight:bold;line-height:70px;font-size:11px;'>Signature</div>" +
...
OB.ECOM.Process = {
  execute: function (params, view) {
    ...
    callback = function (rpcResponse, data, rpcRequest) {
    	 ...
    	 processLayout = isc.ECOMPickValidateProcessNew.create({
    	        parentWindow: view,
    	        pickGridData: data,
//    	        processAction: processAction
    ...
    OB.RemoteCallManager.call('in.decathlon.b2c.eCommerce.ManualProcessActionHandler', {
    	recordId : recordId,
    	action: params.action
    }, {}, callback);
  },

  printInvoice: function (params, view) {
    params.action = 'printInvoice';
    OB.ECOM.Process.execute(params, view);
  }
};
