...
public class ItemCodeSelector extends HttpSecureAppServlet 
{
  private static final long serialVersionUID = 1L;

  private static final String[] colNames = { "SearchKey", "ItemCode", "M_Product_ID", "RowKey" };
      ...
      ServletException 
 {
    ...
    {
      String windowId = vars.getRequestGlobalVariable("WindowID", "ItemCodeSelector.windowId");
      System.out.println("windowId: " + windowId);
      String strKeyValue = vars.getGlobalVariable("inpSearchKey", "ItemCodeSelector.searchkey", "");
      String strNameValue = vars.getGlobalVariable("inpItemCode", "ItemCodeSelector.itemcode", "");

      PrintPage(response, vars, strKeyValue, strNameValue, windowId, "paramItemCode");
    } 
    ...
    else if (vars.commandIn("DATA")) 
    {
     ...
     {
        vars.removeSessionValue("ItemCodeSelector.searchkey");
        vars.removeSessionValue("ItemCodeSelector.itemcode");
        vars.removeSessionValue("ItemCodeSelector.adorgid");
      }
      String strKey = vars.getGlobalVariable("inpSearchKey", "ItemCodeSelector.searchkey", "");
      String strItemCode = vars.getGlobalVariable("inpItemCode", "ItemCodeSelector.itemcode", "");
      String strOrg = vars.getGlobalVariable("inpAD_Org_ID", "ItemCodeSelector.adorgid", "");
      ...
      { 		// Asking for data rows
        printGridData(response, vars, strKey, strItemCode, strOrg, strSortCols, strSortDirs, strOffset, strPageSize, strNewFilter);
      } 
      else if (action.equalsIgnoreCase("getIdsInRange")) 
      {
        	// asking for selected rows

        printGridDataSelectedRows(response, vars, strKey, strItemCode, strOrg, strSortCols, strSortDirs);
      } 
      else 
     {
  ...
  private void PrintPage(HttpServletResponse response, VariablesSecureApp vars, String strKeyValue,
      String strNameValue, String windowId, String focusedId) throws IOException, ServletException 
 {
    if (log4j.isDebugEnabled())
      log4j.debug("Output: Multiple products seeker Frame Set");
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
        "org/openbravo/decathlon/upgrade/erpCommon/info/ItemCodeSelector").createXmlDocument();
    ...
    {
      xmlDocument.setParameter("searchkey", strKeyValue);
    }
    xmlDocument.setParameter("directory", "var baseDirectory = \"" + strReplaceWith + "/\";\n");
    xmlDocument.setParameter("language", "defaultLang=\"" + vars.getLanguage() + "\";");
    xmlDocument.setParameter("theme", vars.getTheme());
    xmlDocument.setParameter("itemcode", strNameValue);
  ...
  private void printGridStructure(HttpServletResponse response, VariablesSecureApp vars)throws IOException, ServletException 
 {
  ...
  private SQLReturnObject[] getHeaders(VariablesSecureApp vars)
  {
    ...
    String[] colWidths = { "109", "225", "300","275","200","100", "0", "0" };
  ...
  private void printGridData(HttpServletResponse response, VariablesSecureApp vars, String strKey, String strItemCode,  String strOrg, String strOrderCols, String strOrderDirs, String strOffset, String strPageSize, String strNewFilter)
      throws IOException, ServletException 
 {
    ...
    if (headers != null) 
    {
      try 
      {
        ...
        page = TableSQLData.calcAndGetBackendPage(vars, "ItemCodeSelectorData.currentPage");
        ...
        { 
          ...
          strNumRows = ItemCodeSelectorData.countRows(this,rownum, strKey, strItemCode,
              Utility.getContext(this, vars, "#User_Client", "ItemCodeSelector"), Utility
        ...
        if (this.myPool.getRDBMS().equalsIgnoreCase("ORACLE")) 
        {
          ...
          data = ItemCodeSelectorData.select(this, "ROWNUM", strKey, strItemCode,
              Utility.getContext(this, vars, "#User_Client", "ItemCodeSelector"), Utility
        ...
        else 
        {
          ...
          data = ItemCodeSelectorData.select(this, "1", strKey, strItemCode, Utility
              .getContext(this, vars, "#User_Client", "ItemCodeSelector"), Utility.getSelectorOrgs(
   ...
   * 
   */
  private void printGridDataSelectedRows(HttpServletResponse response, VariablesSecureApp vars, String strKey, String strItemCode, String strOrg, String strOrderCols, String strOrderDirs) throws IOException, ServletException 
{
    ...
    try 
    {
      ...
      String strOrderBy = SelectorUtility.buildOrderByClause(strOrderCols, strOrderDirs);
      String strPage = vars.getSessionValue("ItemCodeSelector|currentPage", "0");
