...
public class ProductBrand extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;

  private static final String[] colNames = { "Value", "Name", "Brand", "Model","Size","Color","M_Product_ID",
      "RowKey" };
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strNameValue = vars.getRequestGlobalVariable("inpNameValue", "ProductBrand.Brand");
      ...
      String windowId = vars.getRequestGlobalVariable("WindowID", "ProductBrand.windowId");
      System.out.println("windowId: " + windowId);

      String strBrand = vars.getGlobalVariable("inpBrand", "ProductBrand.brand", Utility.getContext(this, vars, "CL_Brand_ID", windowId));
      System.out.println("Brand: " + strBrand);

      String strKeyValue = vars.getGlobalVariable("inpKey", "ProductBrand.key", "");
      String strNameValue = vars.getGlobalVariable("inpName", "ProductBrand.name", "");
      PrintPage(response, vars, strKeyValue, strNameValue, strBrand, windowId, "paramName");
      ...
      if (vars.getStringParameter("clear").equals("true")) {
        vars.removeSessionValue("ProductBrand.key");
        vars.removeSessionValue("ProductBrand.name");
        vars.removeSessionValue("ProductBrand.brand");
        vars.removeSessionValue("ProductBrand.adorgid");
      }
      String strKey = vars.getGlobalVariable("inpKey", "ProductBrand.key", "");
      String strName = vars.getGlobalVariable("inpName", "ProductBrand.name", "");
      String strBrand = vars.getGlobalVariable("inpBrand",
          "ProductBrand.brand", "");
      String strOrg = vars.getGlobalVariable("inpAD_Org_ID", "ProductBrand.adorgid", "");
      ...
      if (action.equalsIgnoreCase("getRows")) { // Asking for data rows
        printGridData(response, vars, strKey, strName, strBrand, strOrg, strSortCols,
            strSortDirs, strOffset, strPageSize, strNewFilter);
      } else if (action.equalsIgnoreCase("getIdsInRange")) {
        // asking for selected rows
        printGridDataSelectedRows(response, vars, strKey, strName, strBrand, strOrg,
  ...
  private void PrintPage(HttpServletResponse response, VariablesSecureApp vars, String strKeyValue,
      String strNameValue, String strBrand, String windowId, String focusedId) throws IOException, ServletException {
    if (log4j.isDebugEnabled())
      log4j.debug("Output: Multiple products seeker Frame Set");
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
        "org/openbravo/decathlon/upgrade/erpCommon/info/ProductBrand").createXmlDocument();
    ...
    xmlDocument.setData("structure1", BrandComboData.select(this, vars.getClient()));
  ...
  private void printGridData(HttpServletResponse response, VariablesSecureApp vars, String strKey,
      String strName, String strBrand, String strOrg, String strOrderCols,
    ...
    if (headers != null) {
      try {
        ...
        if (strNewFilter.equals("1") || strNewFilter.equals("")) { // New
          ...
          strNumRows = ProductBrandData.countRows(this,rownum, strKey, strName, strBrand,
              Utility.getContext(this, vars, "#User_Client", "ProductBrand"), Utility
        ...
        if (this.myPool.getRDBMS().equalsIgnoreCase("ORACLE")) {
          ...
          data = ProductBrandData.select(this, "ROWNUM", strKey, strName, strBrand,
              Utility.getContext(this, vars, "#User_Client", "ProductBrand"), Utility
                  .getSelectorOrgs(this, vars, strOrg), strOrderBy, "", oraLimit1, oraLimit2);
        } else {
          String pgLimit = pageSize + " OFFSET " + offset;
          data = ProductBrandData.select(this, "1", strKey, strName, strBrand, Utility
              .getContext(this, vars, "#User_Client", "ProductBrand"), Utility.getSelectorOrgs(
  ...
  private void printGridDataSelectedRows(HttpServletResponse response, VariablesSecureApp vars,
      String strKey, String strName, String strBrand, String strOrg, String strOrderCols,
    ...
    try {
      // build sql orderBy clause
      String strOrderBy = SelectorUtility.buildOrderByClause(strOrderCols, strOrderDirs);
      String strPage = vars.getSessionValue("ProductBrand|currentPage", "0");
