...
public class BusinessPartner extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      final String strContact = vars.getGlobalVariable("inpContact", "BusinessPartner.mobile", "");
      final String decathid = vars.getGlobalVariable("decathlonId", "BusinessPartner.decathlonid",
          "");
      final String emailid = vars.getGlobalVariable("emailId", "BusinessPartner.emailid", "");
      final String landline = vars.getGlobalVariable("landlineId", "BusinessPartner.landline", "");
      ...
      printGridData(response, vars, strKey, strName, strOrg, strContact, decathid, emailid,
          landline, strZIP, strProvincia, strBpartners, strCity, strSortCols, strSortDirs,
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars, String strKeyValue,
    ...
    final XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
        "org/openbravo/decathlon/upgrade/erpCommon/info/BusinessPartner").createXmlDocument();
  ...
  private void printGridData(HttpServletResponse response, VariablesSecureApp vars, String strKey,
      String strName, String strOrg, String strContact, String decathid, String emailid,
      String landline, String strZIP, String strProvincia, String strBpartners, String strCity,
      ...
      try {
        ...
        if (strNewFilter.equals("1") || strNewFilter.equals("")) {
          ...
          strNumRows = BusinessPartnerData.countRows(this, rownum, Utility.getContext(this, vars,
              ...
              strKey, strName, strContact, decathid, emailid, landline, strZIP, strProvincia,
      ...
      for (int j = 0; j < data.length; j++) {
        ...
        for (int k = 0; k < headers.length; k++) {
          ...
          if (columnname.equalsIgnoreCase("so_creditavailable")
            ...
            // strRowsData.append(data[j].getField(columnname) + " " + data[j].getField("name2"));
            strRowsData.append(data[j].getField(columnname));
            if (data[j].getField("name2") != null) {
              strRowsData.append("," + data[j].getField("name2"));
            }
            if (data[j].getField("em_rc_mobile") != null) {
              strRowsData.append(" (" + data[j].getField("em_rc_mobile") + ")");
            }

            if (data[j].getField("companyname") != null) {
              strRowsData.append("-" + data[j].getField("companyname"));
            }
  ...
  private void clearSessionValue(VariablesSecureApp vars) {
    ...
    vars.removeSessionValue("BusinessPartner.decathlonid");
    vars.removeSessionValue("BusinessPartner.emailid");
    vars.removeSessionValue("BusinessPartner.landline");
    vars.removeSessionValue("BusinessPartner.mobile");
