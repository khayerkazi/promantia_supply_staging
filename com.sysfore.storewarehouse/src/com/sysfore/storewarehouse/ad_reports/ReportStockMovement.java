...
public class ReportStockMovement extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strDateFrom = vars.getRequestGlobalVariable("inpDateFrom",
          "ReportStockMovement|dateFrom");
      System.out.println("strDateFrom: in Default " + strDateFrom);

      String strDateTo = vars.getRequestGlobalVariable("inpDateTo", "ReportStockMovement|dateTo");
      System.out.println("strDateTo: in Default " + strDateTo);

      String strProduct = vars.getInGlobalVariable("inpmProductId_IN",
          "ReportStockMovement|product", "", IsIDFilter.instance);
     vars.setSessionValue("ReportStockMovement|product", "");
      ...
      String strMovementtype = vars.getGlobalVariable("inpemswMovementtypegm",
          "ReportStockMovement|Movementtype", "");
      System.out.println("strMovementtype: in Default " + strMovementtype);

      String strBrand = vars.getGlobalVariable("inpclBrandId", "ReportStockMovement|brand", "");
      System.out.println("strBrand: in default " + strBrand);

      printPageDataSheet(response, vars, strDateFrom, strDateTo, strProduct, strmWarehouseId,
          strMovementtype, strBrand);
      ...
      String strBrand = vars.getRequestGlobalVariable("inpclBrandId", "ReportStockMovement|brand");
      System.out.println("strBrand: in Find " + strBrand);

      String strMovementtype = vars.getRequestGlobalVariable("inpemswMovementtypegm",
          "ReportStockMovement|Movementtype");
      System.out.println("strMovementtype: in Find " + strMovementtype);
      ...
      printPageHtml(request, response, vars, strDateFrom, strDateTo, strProduct, strmWarehouseId,
          strMovementtype, strBrand, "html");
      ...
      String strMovementtype = vars.getRequestGlobalVariable("inpemswMovementtypegm",
          "ReportStockMovement|Movementtype");
      System.out.println("strMovementtype: in XLS " + strMovementtype);
      ...
      printPageXls(response, vars, strDateFrom, strDateTo, strProduct, strmWarehouseId,
          strMovementtype, strBrand);
  ...
  void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars,
      String strDateFrom, String strDateTo, String strProduct, String strmWarehouseId,
      String strMovementtype, String strBrand) throws IOException, ServletException {
    ...
    xmlDocument = xmlEngine.readXmlTemplate(
        "com/sysfore/storewarehouse/ad_reports/ReportStockMovement").createXmlDocument();
    ...
    try {
      WindowTabs tabs = new WindowTabs(this, vars,
          "com.sysfore.storewarehouse.ad_reports.ReportStockMovement");
      xmlDocument.setParameter("parentTabContainer", tabs.parentTabs());
      xmlDocument.setParameter("mainTabContainer", tabs.mainTabs());
      xmlDocument.setParameter("childTabContainer", tabs.childTabs());
      xmlDocument.setParameter("theme", vars.getTheme());
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "ReportStockMovement.html",
          classInfo.id, classInfo.type, strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "ReportStockMovement.html",
          strReplaceWith);
    ...
    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "ReportStockMovement", false, "", "",
    ...
    OBError myMessage = vars.getMessage("ReportStockMovement");
    vars.removeMessage("ReportStockMovement");
    if (myMessage != null) {
    ...
    xmlDocument.setParameter("Movementtype", strMovementtype);
    ...
    try {
      ComboTableData comboTableData = new ComboTableData(vars, this, "TABLEDIR", "cl_brand_id", "",
          "", Utility.getContext(this, vars, "#AccessibleOrgTree", "ReportStockMovement"), Utility
              .getContext(this, vars, "#User_Client", "ReportStockMovement"), 0);
      Utility.fillSQLParameters(this, vars, null, comboTableData, "ReportStockMovement", strBrand);
    ...
    try {
      ComboTableData comboTableData = new ComboTableData(vars, this, "TABLEDIR", "m_warehouse_id",
          "", "", Utility.getContext(this, vars, "#AccessibleOrgTree", "ReportStockMovement"),
          Utility.getContext(this, vars, "#User_Client", "ReportStockMovement"), 0);
      Utility.fillSQLParameters(this, vars, null, comboTableData, "ReportStockMovement",
          strmWarehouseId);
    ...
    try {
      ComboTableData comboTableData = new ComboTableData(vars, this, "17", "MovementType",
          "63C70C976A804530BF81BCEDEDBE586E", "", Utility.getContext(this, vars,
              "#AccessibleOrgTree", "ReportStockMovement"), Utility.getContext(this, vars,
              "#User_Client", "ReportStockMovement"), 0);
      Utility.fillSQLParameters(this, vars, null, comboTableData, "ReportStockMovement",
          strMovementtype);
  ...
  void printPageHtml(HttpServletRequest request, HttpServletResponse response,
      ...
      String strmWarehouseId, String strMovementtype, String strBrand, String strOutput)
  ...
  void printPageXls(HttpServletResponse response, VariablesSecureApp vars, String strDateFrom,
      String strDateTo, String strProduct, String strmWarehouseId, String strMovementtype,
      String strBrand) throws IOException, ServletException {
  ...
  public String getServletInfo() {
    return "ReportStockMovement for displaying in excel format";
