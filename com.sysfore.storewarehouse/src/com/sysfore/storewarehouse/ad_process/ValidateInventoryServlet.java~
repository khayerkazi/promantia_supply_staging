...
public class ValidateInventoryServlet extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      result = ValidateInventoryData.validateInventory(this, client);
      ...
      vars.setSessionValue(strTabId + "|ImportInventoryB7266A48228C42A1B1DA898D75F5C417.view", "");
      vars.setMessage(strTabId, myError);
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars,
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
        "com/sysfore/storewarehouse/ad_process/ValidateInventoryServlet").createXmlDocument();
