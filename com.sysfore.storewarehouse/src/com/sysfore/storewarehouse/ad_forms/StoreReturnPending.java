...
public class StoreReturnPending extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    // if (!Utility.hasProcessAccess(this, vars, "", "StoreReturnPending")) {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String stradOrgId = vars.getStringParameter("inpOrg", "");
      ...
      while (st.hasMoreTokens()) {
        ...
        StoreReturnPending1Data[] data = StoreReturnPending1Data.selectline1(this, myToken);
     ...
     if (strDateReceipt.equals(null)){
      ...
      myError.setTitle(Utility.messageBD(this, "No Date Shipped is defined.", vars.getLanguage()));
        ...
        StoreReturnPending1Data.processRequisition(this, myToken);
        StoreReturnPending1Data[] lines = null;
        lines = StoreReturnPending1Data.selectReqLine(this, myToken);
        if (lines != null) {
...
//StoreReturnPending1Data.createTransaction(this, enteredQty.trim(), warehousefrom.trim(),warehouse.trim(), strDateReceipt.trim(), lines[i].id.trim());

StoreReturnPending1Data.updateLines(this, enteredQty.trim(), warehouse.trim(), strDateReceipt.trim(), lines[i].id.trim(), user.trim());
...
" "+strDateReceipt.trim()+" "+lines[i].id.trim()+" "+"end");
  ...
  void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars,
    ...
    StoreReturnPending1Data[] data = StoreReturnPending1Data.selectline(this, strclBrandId, stradOrgId, strDateFrom, strDateTo, strDocumentNo);
    ...
    xmlDocument = xmlEngine.readXmlTemplate(
        "com/sysfore/storewarehouse/ad_forms/StoreReturnPending").createXmlDocument();
    ...
    try {
      WindowTabs tabs = new WindowTabs(this, vars,
          "com.sysfore.storewarehouse.ad_forms.StoreReturnPending");
      xmlDocument.setParameter("parentTabContainer", tabs.parentTabs());
      xmlDocument.setParameter("mainTabContainer", tabs.mainTabs());
      xmlDocument.setParameter("childTabContainer", tabs.childTabs());
      xmlDocument.setParameter("theme", vars.getTheme());
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
          "StoreReturnPending.html", classInfo.id, classInfo.type, strReplaceWith, tabs
              .breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "StoreReturnPending.html",
          strReplaceWith);
    ...
    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "StoreReturnPending", false, "",
    ...
    /*
     * OBError myMessage = vars.getMessage("StoreReturnPending");
     * vars.removeMessage("StoreReturnPending"); if (myMessage!=null) {
    ...
    xmlDocument.setParameter("date", StoreReturnPending1Data.selectDate(this, clientId));
    ...
    try {
      ComboTableData comboTableData = new ComboTableData(vars, this, "TABLEDIR", "cl_Brand_ID", "",
          "", Utility.getContext(this, vars, "#AccessibleOrgTree",
              "StoreReturnPending"), Utility.getContext(this, vars, "#User_Client",
              "StoreReturnPending"), 0);
      Utility.fillSQLParameters(this, vars, null, comboTableData, "StoreReturnPending",
          strclBrandId);
  ...
  /*try {
    ...
    String warehouse = StoreReturnPending1Data.selectLocator(this, orgId);
    ...
    try {
      ...
      Utility.fillSQLParameters(this, vars, null, comboTableData, "StoreReceiptPending", StoreReturnPending1Data.selectLocator(this, orgId));
    ...
    if (commandIn.equals("GENERATE")) {
      ...
      // result = StoreReturnPending1Data.processReturn(this, strswSrequisitionId);
        //String strDateReceipt = "";
        //strDateReceipt = vars.getStringParameter("inpDateShipped" + data[0].adOrgId);
          ...
          for (i = 0; i < data.length; i++) {
            if (data[i].id.equals(strRequisitionlineId)) {
              ...
              html.append("document.getElementsByName(\"" + "inpmWarehouseId"
                  ...
                  + StoreReturnPending1Data.selectWarehouse(this, strWarehouse) + "';\n");
  ...
  public String getServletInfo() {
    return "StoreReturnPending controller servlet made specifically for CBD Training";
