...
public class ValidateInventoryServlet extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    String process = "ValidateInventory";// ImportData.processId(this, "ImportProduct");
    if (vars.commandIn("DEFAULT")) {
      System.out.println("Inside the Default Inventory");
      String strTabId = vars.getGlobalVariable("inpTabId", "ValidateInventoryServlet|tabId");
      ...
      result = ValidateInventoryData.validateInventory(this, client,organistation);
      ...
      vars.setSessionValue(strTabId + "|InventoryAE08E1109BC94E0CB7442911C19F82D4.view", "");
      vars.setMessage(strTabId, myError);
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars,
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
        "com/sysfore/decathlonimport/ad_process/ValidateInventoryServlet").createXmlDocument();
  ...
  public String getServletInfo() {
    return "Servlet ValidateInventoryServlet";
