...
public class ValidateOxylaneIdServlet extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    String process = "ValidateOxylaneId";// ImportData.processId(this, "ImportProduct");
    if (vars.commandIn("DEFAULT")) {
      System.out.println("Inside the Default Product");
      String strTabId = vars.getGlobalVariable("inpTabId", "ValidateOxylaneIdServlet|tabId");
      String strWindowId = vars.getGlobalVariable("inpwindowId",
          "ValidateOxylaneIdServlet|windowId");
      ...
      String strTabId = vars.getRequestGlobalVariable("inpTabId",
          "ValidateOxylaneIdServlet|tabId");
      ...
      result = ValidateOxylaneIdData.validateOxylaneIdlist(this, client);
      ...
      vars.setSessionValue(strTabId + "|ImportOxylaneId4AC58562A2774CF2B6B76727A483460A.view", "");
      vars.setMessage(strTabId, myError);
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars,
    ...
    if (log4j.isDebugEnabled())
      log4j.debug("Output: process ValidateOxylaneIdServlet");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
        "com/sysfore/decathlonimport/ad_process/ValidateOxylaneIdServlet").createXmlDocument();
  ...
  public String getServletInfo() {
    return "Servlet ValidateOxylaneIdServlet";
