...
public class ValidateProductCatalogServlet extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    String process = "ValidateProductCatalog";// ImportData.processId(this, "ImportProduct");
    OBError myError = new OBError();
    if (vars.commandIn("DEFAULT")) {
      System.out.println("Inside the Default Product");
      String strTabId = vars.getGlobalVariable("inpTabId", "ValidateProductCatalogServlet|tabId");
      String strWindowId = vars.getGlobalVariable("inpwindowId",
          "ValidateProductCatalogServlet|windowId");
      ...
      //Validating the user for * organization
      System.out.println("Ad org"+vars.getOrg());
      if (vars.getOrg().equals("0")==false) {
        myError.setType("Error");
        myError.setTitle(Utility.messageBD(this, "Error", vars.getLanguage()));
        myError.setMessage(Utility.messageBD(this, "Organization should be *", vars.getLanguage()));
      } else {
        result = ValidateProductCatalogData.validateCatalogItems(this, client);
      ...
      vars.setSessionValue(strTabId + "|ImportProductCatalogCD88B165E3D64FCB97021BCEDA532F92.view",
          "");
      vars.setMessage(strTabId, myError);
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars,
    ...
    if (log4j.isDebugEnabled())
      log4j.debug("Output: process ValidateProductCatalogServlet");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
        "com/sysfore/decathlonimport/ad_process/ValidateProductCatalogServlet").createXmlDocument();
  ...
  public String getServletInfo() {
    return "Servlet ValidateProductCatalogServlet";
