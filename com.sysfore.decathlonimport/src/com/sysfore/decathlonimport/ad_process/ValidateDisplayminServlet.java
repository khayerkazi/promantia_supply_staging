...
public class ValidateDisplayminServlet extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    String process = "ValidateDisplaymin";// ImportData.processId(this, "ImportProduct");
    if (vars.commandIn("DEFAULT")) {
      System.out.println("Inside the Default Product");
      String strTabId = vars.getGlobalVariable("inpTabId", "ValidateDisplayminServlet|tabId");
      String strWindowId = vars.getGlobalVariable("inpwindowId",
          "ValidateDisplayminServlet|windowId");
      ...
      result = ValidateDisplayminData.validateDisplaymin(this, user, adOrgId);
//      result = ValidateDisplayminData.validateDisplaymin(this, user);
      ...
      vars.setSessionValue(strTabId + "|ImportDisplaymin895EBECEAA804BE79C56F6FB558A0248.view", "");
      vars.setMessage(strTabId, myError);
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars,
    ...
    if (log4j.isDebugEnabled())
      log4j.debug("Output: process ValidateDisplayminServlet");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
        "com/sysfore/decathlonimport/ad_process/ValidateDisplayminServlet").createXmlDocument();
  ...
  public String getServletInfo() {
    return "Servlet ValidateDisplayminServlet";
