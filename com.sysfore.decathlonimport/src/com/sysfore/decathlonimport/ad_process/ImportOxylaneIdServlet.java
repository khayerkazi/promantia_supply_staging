...
public class ImportOxylaneIdServlet extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    String process = "ImportOxylaneId";// ImportData.processId(this, "ImportProduct");
    if (vars.commandIn("DEFAULT")) {
      System.out.println("Inside the Default OxylaneIdlist");
      String strTabId = vars.getGlobalVariable("inpTabId", "ImportOxylaneIdServlet|tabId");
      String strWindowId = vars.getGlobalVariable("inpwindowId",
          "ImportOxylaneIdServlet|windowId");
      ...
      result = ImportOxylaneIdData.importOxylaneId(this, client, organistation, user);
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars,
    ...
    if (log4j.isDebugEnabled())
      log4j.debug("Output: process ImportOxylaneIdServlet");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
        "com/sysfore/decathlonimport/ad_process/ImportOxylaneIdServlet").createXmlDocument();
  ...
  public String getServletInfo() {
    return "Servlet ImportOxylaneIdServlet";
