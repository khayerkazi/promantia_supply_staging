...
public class ValidateStorePriceServlet extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    String process = "ValidateStorePrice";// ImportData.processId(this, "ImportProduct");
    if (vars.commandIn("DEFAULT")) {
      System.out.println("Inside the Default Product");
      String strTabId = vars.getGlobalVariable("inpTabId", "ValidateStorePriceServlet|tabId");
      String strWindowId = vars.getGlobalVariable("inpwindowId",
          "ValidateStorePriceServlet|windowId");
      ...
      String strTabId = vars.getRequestGlobalVariable("inpTabId",
          "ValidateStorePriceServlet|tabId");
      ...
      result = ValidateStorePriceData.validateStorePricelist(this, user);
      ...
      vars.setSessionValue(strTabId + "|ImportStorePricelist895EBECEAA804BE79C56F6FB558A0248.view", "");
      vars.setMessage(strTabId, myError);
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars,
    ...
    if (log4j.isDebugEnabled())
      log4j.debug("Output: process ValidateStorePriceServlet");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
        "com/sysfore/decathlonimport/ad_process/ValidateStorePriceServlet").createXmlDocument();
  ...
  public String getServletInfo() {
    return "Servlet ValidateStorePriceServlet";
