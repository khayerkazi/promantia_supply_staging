...
public class ValidateImportMembers extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    String process = "ValidateImportMembers";// ImportData.processId(this, "ImportProduct");
    if (vars.commandIn("DEFAULT")) {
      System.out.println("Inside the Import members");
      String strTabId = vars.getGlobalVariable("inpTabId", "ValidateImportMembers|tabId");
      String strWindowId = vars.getGlobalVariable("inpwindowId",
          "ValidateImportMembers|windowId");
     ...
     // result = ValidateFobPriceData.validateFobPricelist(this, client);
      result = ValidateMembersData.validateMember(myPool, user);
      ...
      vars.setSessionValue(strTabId + "|ImportMembersC46B222F155542F189460A42F74696E3.view", "");
      
      System.out.println("I am passing view------- ");  
      vars.setMessage(strTabId, myError);
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars,
    ...
    if (log4j.isDebugEnabled())
      log4j.debug("Output: process ValidateImportMembers");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
        "com/sysfore/decathlonimport/ad_process/ValidateImportMembers").createXmlDocument();
