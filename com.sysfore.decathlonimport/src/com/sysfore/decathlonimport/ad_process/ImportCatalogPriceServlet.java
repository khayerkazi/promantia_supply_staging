...
public class ImportCatalogPriceServlet extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    String process = "ImportCatalogPrice";// ImportData.processId(this, "ImportProduct");
    if (vars.commandIn("DEFAULT")) {
      System.out.println("Inside the Default Catalogpricelist");
      String strTabId = vars.getGlobalVariable("inpTabId", "ImportCatalogPriceServlet|tabId");
      String strWindowId = vars.getGlobalVariable("inpwindowId",
          "ImportCatalogPriceServlet|windowId");
      ...
      result = ImportCatalogPriceData.importCatalogPrice(this, client, organistation, user);
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars,
    ...
    if (log4j.isDebugEnabled())
      log4j.debug("Output: process ImportCatalogPriceServlet");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
        "com/sysfore/decathlonimport/ad_process/ImportCatalogPriceServlet").createXmlDocument();
  ...
  public String getServletInfo() {
    return "Servlet ImportCatalogPriceServlet";
