...
public class ImportProductCatalogServlet extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    String process = "ImportProductCatalog";// ImportData.processId(this, "ImportProduct");
    if (vars.commandIn("DEFAULT")) {
      System.out.println("Inside the Default ProductCatalog");
      String strTabId = vars.getGlobalVariable("inpTabId", "ImportProductCatalogServlet|tabId");
      String strWindowId = vars.getGlobalVariable("inpwindowId",
          "ImportProductCatalogServlet|windowId");
      ...
      String strTabId = vars.getRequestGlobalVariable("inpTabId",
          "ImportProductCatalogServlet|tabId");
      ...
      result = ImportProductCatalogData.importProductCatalog(this, client, organistation, user);
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars,
    ...
    if (log4j.isDebugEnabled())
      log4j.debug("Output: process ImportProductCatalogServlet");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
        "com/sysfore/decathlonimport/ad_process/ImportProductCatalogServlet").createXmlDocument();
  ...
  public String getServletInfo() {
    return "Servlet ImportProductCatalogServlet";
