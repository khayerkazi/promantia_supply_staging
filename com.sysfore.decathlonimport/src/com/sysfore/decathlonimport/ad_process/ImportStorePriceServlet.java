...
public class ImportStorePriceServlet extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    String process = "ImportStorePrice";// ImportData.processId(this, "ImportProduct");
    if (vars.commandIn("DEFAULT")) {
      System.out.println("Inside the Default Storepricelist");
      String strTabId = vars.getGlobalVariable("inpTabId", "ImportStorePriceServlet|tabId");
      String strWindowId = vars.getGlobalVariable("inpwindowId",
          "ImportStorePriceServlet|windowId");
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars,
    ...
    if (log4j.isDebugEnabled())
      log4j.debug("Output: process ImportStorePriceServlet");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
        "com/sysfore/decathlonimport/ad_process/ImportStorePriceServlet").createXmlDocument();
  ...
  public String getServletInfo() {
    return "Servlet ImportStorePriceServlet";
