...
public class ValidateCatalogPriceServlet extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    String process = "ValidateCatalogPrice";// ImportData.processId(this, "ImportProduct");
    if (vars.commandIn("DEFAULT")) {
      System.out.println("Inside the Default Product");
      String strTabId = vars.getGlobalVariable("inpTabId", "ValidateCatalogPriceServlet|tabId");
      String strWindowId = vars.getGlobalVariable("inpwindowId",
          "ValidateCatalogPriceServlet|windowId");
      ...
      result = ValidateCatalogPriceData.validateCatalogPricelist(this, client);
      ...
      vars.setSessionValue(strTabId + "|ImportCatalogPricelist7D9257A25C24405DAB10E04E441FC87C.view", "");
      vars.setMessage(strTabId, myError);
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars,
    ...
    if (log4j.isDebugEnabled())
      log4j.debug("Output: process ValidateCatalogPriceServlet");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
        "com/sysfore/decathlonimport/ad_process/ValidateCatalogPriceServlet").createXmlDocument();
  ...
  public String getServletInfo() {
    return "Servlet ValidateCatalogPriceServlet";
