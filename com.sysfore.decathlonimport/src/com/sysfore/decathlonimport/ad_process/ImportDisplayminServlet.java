...
public class ImportDisplayminServlet extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    String process = "ImportDisplaymin";// ImportData.processId(this, "ImportProduct");
    if (vars.commandIn("DEFAULT")) {
      System.out.println("Inside the Default ImportDisplaymin");
      String strTabId = vars.getGlobalVariable("inpTabId", "ImportDisplayminServlet|tabId");
      String strWindowId = vars.getGlobalVariable("inpwindowId",
          "ImportDisplayminServlet|windowId");
      ...
      result = ImportDisplayminData.importDisplaymin(this, client, organistation, user);
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars,
    ...
    if (log4j.isDebugEnabled())
      log4j.debug("Output: process ImportDisplayminServlet");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
        "com/sysfore/decathlonimport/ad_process/ImportDisplayminServlet").createXmlDocument();
  ...
  public String getServletInfo() {
    return "Servlet ImportDisplayminServlet";
