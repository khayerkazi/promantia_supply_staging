...
public class ImportInventoryServlet extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    String process = "ImportInventory";// ImportData.processId(this, "ImportProduct");
    if (vars.commandIn("DEFAULT")) {
      System.out.println("Inside the Default Inventory");
      String strTabId = vars.getGlobalVariable("inpTabId", "ImportInventoryServlet|tabId");
      String strWindowId = vars.getGlobalVariable("inpwindowId",
          "ImportInventoryServlet|windowId");
      ...
      result = ImportInventoryData.importinventory(this, client, organistation, user);
      	...
      	if(result_array.length > 1) {
      		 errortype = result_array[0]; 
    		 errormsg = result_array[1];
      	} else {
      		errortype = "Error";
      		errormsg = result_array[0];
      	}
		
      myError.setType(errortype);
      myError.setTitle(Utility.messageBD(this, errortype, vars.getLanguage()));
      myError.setMessage(Utility.messageBD(this, errormsg, vars.getLanguage()));
      vars.setMessage(strTabId, myError);
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars,
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
        "com/sysfore/decathlonimport/ad_process/ImportInventoryServlet").createXmlDocument();
  ...
  public String getServletInfo() {
    return "Servlet ImportInventoryServlet";
