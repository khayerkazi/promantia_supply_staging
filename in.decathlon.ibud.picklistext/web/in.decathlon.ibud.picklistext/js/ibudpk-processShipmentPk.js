...
isc.defineClass('IBUDPK_ShipmentPopup', isc.OBPopup);
isc.IBUDPK_ShipmentPopup.addProperties({
  ...
  initWidget: function () {
    ...
    this.setTitle(OB.I18N.getLabel('IBUDPK_ProcessShipment'));
    ...
    this.okButton = isc.OBFormButton.create({
      ...
      action: function () {
        ...
        OB.RemoteCallManager.call('in.decathlon.ibud.picklistext.ShipmentActionHandler', {
          pickings: pickings,
          action: 'ship',
        }, {}, callback, {
