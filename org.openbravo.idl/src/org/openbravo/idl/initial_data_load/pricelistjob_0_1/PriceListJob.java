...
public class PriceListJob {
	...
	private final String jobName = "PriceListJob";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(PriceListJob.this, new Object[] { e,
									globalMap });
							break;
						}
					}
	...
	public void tJavaRow_10_error(Exception exception,
			final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tFilterRow_6_error(Exception exception,
			final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tFuzzyMatch_2_error(Exception exception,
			final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tFilterRow_4_error(Exception exception,
			final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tJavaRow_15_error(Exception exception,
			final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tFilterRow_5_error(Exception exception,
			final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tJavaRow_8_error(Exception exception,
			final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tJavaRow_12_error(Exception exception,
			final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tJavaRow_7_error(Exception exception,
			final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tJavaRow_6_error(Exception exception,
			final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tJavaRow_14_error(Exception exception,
			final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tHash_row20_error(Exception exception,
			final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	static class row22Struct implements
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime
						* result
						+ ((this.PriceListName == null) ? 0
								: this.PriceListName.hashCode());
			...
			synchronized (commonByteArrayLock) {
				...
				try {
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.PriceListName = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.IsTaxIncluded = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.EnforcePriceLimit = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.PriceListVersionName = new String(commonByteArray,
								0, length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.DiscountSchema = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.ValidFromDate = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.BasePriceListVersion = new String(commonByteArray,
								0, length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.ProductName = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.StandardPrice = new String(commonByteArray, 0,
								length);
					}
		...
		public int compareTo(row22Struct other) {
			...
			returnValue = checkNullsAndCompare(this.PriceListName,
					other.PriceListName);
			if (returnValue != 0) {
				return returnValue;
			}
	...
	static class row24Struct implements
	...
	static class row8Struct implements
	...
	static class row15Struct implements
	...
	static class row14Struct implements
	...
	static class row10Struct implements
	...
	static class row9Struct implements
			...
			while (limittFileInputDelimited_1 != 0
				...
				try {
					...
					if (rowtFileInputDelimited_1.length == 1
						...
						if (1 < rowtFileInputDelimited_1.length) {
							row1.PriceListName = rowtFileInputDelimited_1[1]
									.trim();
						...
						if (3 < rowtFileInputDelimited_1.length) {
							row1.IsTaxIncluded = rowtFileInputDelimited_1[3]
									.trim();
						...
						if (6 < rowtFileInputDelimited_1.length) {
							row1.EnforcePriceLimit = rowtFileInputDelimited_1[6]
									.trim();
						...
						if (7 < rowtFileInputDelimited_1.length) {
							row1.PriceListVersionName = rowtFileInputDelimited_1[7]
									.trim();
						...
						if (8 < rowtFileInputDelimited_1.length) {
							row1.DiscountSchema = rowtFileInputDelimited_1[8]
									.trim();
						...
						if (9 < rowtFileInputDelimited_1.length) {
							row1.ValidFromDate = rowtFileInputDelimited_1[9]
									.trim();
						...
						if (10 < rowtFileInputDelimited_1.length) {
							row1.BasePriceListVersion = rowtFileInputDelimited_1[10]
									.trim();
						...
						if (11 < rowtFileInputDelimited_1.length) {
							row1.ProductName = rowtFileInputDelimited_1[11]
									.trim();
						...
						if (12 < rowtFileInputDelimited_1.length) {
							row1.ListPrice = rowtFileInputDelimited_1[12]
									.trim();
						...
						if (13 < rowtFileInputDelimited_1.length) {
							row1.StandardPrice = rowtFileInputDelimited_1[13]
									.trim();
						...
						if (14 < rowtFileInputDelimited_1.length) {
							row1.PriceLimit = rowtFileInputDelimited_1[14]
									.trim();
				...
				if (row1 != null) {
					...
					org.openbravo.idl.proc.Validator validator = service
							.getValidator("Price List");

					row9.Organization = validator
							.checkOrganization(row1.Organization);
					row9.PriceListName = validator.checkNotNull(validator
							.checkString(row1.PriceListName, 60),
							"PriceListName");
					row9.IsDefault = validator.checkNotNull(validator
							.checkBoolean(row1.IsDefault, "IsDefault"),
							"IsDefault");
					row9.IsTaxIncluded = validator.checkNotNull(validator
							.checkBoolean(row1.IsTaxIncluded, "IsTaxIncluded"),
							"IsTaxIncluded");
					row9.IsSales = validator.checkNotNull(validator
							.checkBoolean(row1.IsSales, "IsSalesPriceList"),
							"IsSalesPriceList");
					row9.Currency = validator.checkNotNull(validator
							.checkString(row1.Currency, 32, "Currency"),
							"Currency");
					row9.EnforcePriceLimit = validator.checkNotNull(validator
							.checkBoolean(row1.EnforcePriceLimit,
									"EnforcePriceLimit"), "EnforcePriceLimit");
					row9.PriceListVersionName = validator
							.checkNotNull(validator.checkString(
									row1.PriceListVersionName, 60),
									"PriceListVersionName");
					row9.DiscountSchema = validator.checkNotNull(validator
							.checkString(row1.DiscountSchema, 60,
									"DiscountSchema"), "DiscountSchema");
					row9.ValidFromDate = validator
							.checkDate(row1.ValidFromDate);
					row9.BasePriceListVersion = validator.checkString(
							row1.BasePriceListVersion, 60,
							"BasePriceListVersion");
					row9.ProductName = validator.checkNotNull(validator
							.checkString(row1.ProductName, 60), "ProductName");
					row9.ListPrice = validator.checkBigDecimal(row1.ListPrice);
					row9.StandardPrice = validator
							.checkBigDecimal(row1.StandardPrice);
					row9.PriceLimit = validator
							.checkBigDecimal(row1.PriceLimit);
					...
					(row9.flag == null ? false : row9.flag.toLowerCase()
							.compareTo("0") == 0)
					...
					if (row2 != null) {
						...
						while (tItr_row20_tFuzzyMatch_2.hasNext()) {
							...
							String lookUpValue_tFuzzyMatch_2 = ""
									+ tItr_row20_tFuzzyMatch_2.next().ISOcode;

							int distance_tFuzzyMatch_2 = org.apache.commons.lang.StringUtils
									.getLevenshteinDistance(
											tomatch_tFuzzyMatch_2,
											lookUpValue_tFuzzyMatch_2);

							if (0 <= distance_tFuzzyMatch_2
									&& distance_tFuzzyMatch_2 <= 0) {

								if (matching_tFuzzyMatch_2 == null) {

									value_tFuzzyMatch_2 = new StringBuilder(
											distance_tFuzzyMatch_2 + "");

									matching_tFuzzyMatch_2 = new StringBuilder(
											lookUpValue_tFuzzyMatch_2);
								} else {

									value_tFuzzyMatch_2.append(",").append(
											distance_tFuzzyMatch_2);

									matching_tFuzzyMatch_2.append(",").append(
											lookUpValue_tFuzzyMatch_2);
						...
						((row21.MATCHING == null || "0" == null) ? (row21.MATCHING != "0")
								: row21.MATCHING.compareTo("0") != 0)
						...
						if (row14 != null) {
							...
							Product product = service.findDALInstance(false,
									Product.class, new Value("searchKey",
											row14.ProductName));
							...
							(row15.flag == null ? false : row15.flag
									.toLowerCase().compareTo("0") == 0)
							...
							if (row16 != null) {
								...
								PriceListSchema priceListSchema = service
										.findDALInstance(false,
												PriceListSchema.class,
												new Value("name",
														row16.DiscountSchema));
								row24.flag = (priceListSchema == null) ? "-1"
										: "0";
								...
								(row24.flag == null ? false : row24.flag
										.toLowerCase().compareTo("0") == 0)
								...
								if (row22 != null) {
									...
									service.finishRecordProcess(
											row22.Organization,
											row22.PriceListName,
											row22.IsDefault,
											row22.IsTaxIncluded, row22.IsSales,
											row22.Currency,
											row22.EnforcePriceLimit,
											row22.PriceListVersionName,
											row22.DiscountSchema,
											row22.ValidFromDate,
											row22.BasePriceListVersion,
											row22.ProductName, row22.ListPrice,
											row22.StandardPrice,
											row22.PriceLimit);
									nb_line_tJavaRow_8++;
								...
								if (row19 != null) {
									...
									service
											.logRecordError(
													...
													row19.IsSales,
													row19.Currency,
													row19.EnforcePriceLimit,
													row19.PriceListVersionName,
													row19.DiscountSchema,
													row19.ValidFromDate,
													row19.BasePriceListVersion,
													row19.ProductName,
													row19.ListPrice,
													row19.StandardPrice,
													row19.PriceLimit);
							...
							if (row8 != null) {
								...
								service.logRecordError(service
										.Utility_messageBD("IDL_BAD_REFERENCE")
										+ row8.ProductName, row8.Organization,
										row8.PriceListName, row8.IsDefault,
										row8.IsTaxIncluded, row8.IsSales,
										row8.Currency, row8.EnforcePriceLimit,
										row8.PriceListVersionName,
										row8.DiscountSchema,
										row8.ValidFromDate,
										row8.BasePriceListVersion,
										row8.ProductName, row8.ListPrice,
						...
						if (row7 != null) {
							...
							service.logRecordError(service
									.Utility_messageBD("IDL_BAD_REFERENCE")
									+ row7.Currency, row7.Organization,
									row7.PriceListName, row7.IsDefault,
									row7.IsTaxIncluded, row7.IsSales,
									row7.Currency, row7.EnforcePriceLimit,
									row7.PriceListVersionName,
									row7.DiscountSchema, row7.ValidFromDate,
									row7.BasePriceListVersion,
									row7.ProductName, row7.ListPrice,
									row7.StandardPrice, row7.PriceLimit);
					...
					if (row10 != null) {
						...
						service.logRecordError(row10.whyError,
								row10.Organization, row10.PriceListName,
								row10.IsDefault, row10.IsTaxIncluded,
								row10.IsSales, row10.Currency,
								row10.EnforcePriceLimit,
								row10.PriceListVersionName,
								row10.DiscountSchema, row10.ValidFromDate,
								row10.BasePriceListVersion, row10.ProductName,
								row10.ListPrice, row10.StandardPrice,
								row10.PriceLimit);
	...
	static class row20Struct implements
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime
						* result
						+ ((this.currencyId == null) ? 0 : this.currencyId
								.hashCode());
		...
		public int compareTo(row20Struct other) {
			...
			returnValue = checkNullsAndCompare(this.currencyId,
					other.currencyId);
			if (returnValue != 0) {
				return returnValue;
			}
	...
	public void tJavaFlex_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			final OBCriteria<Currency> obCriteria = OBDal.getInstance()
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			java.io.InputStream inContext = PriceListJob.class
					.getClassLoader()
					.getResourceAsStream(
			...
			if (contextStr.compareTo("Default") != 0) {
				inContext = PriceListJob.class.getClassLoader()
						.getResourceAsStream(
								"initial_data_load/pricelistjob_0_1/contexts/"
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : PriceListJob");
		}
...
/************************************************************************************************
 * 389042 characters generated by Talend Open Studio on the 17 de noviembre de
 * 2009 13:29:58 CET
 ************************************************************************************************/
