...
public class ProductJob {
	...
	private final String jobName = "ProductJob";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(ProductJob.this, new Object[] { e,
									globalMap });
							break;
						}
					}
	...
	static class row60Struct implements
			...
			synchronized (commonByteArrayLock) {
				...
				try {
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.ProductCategory = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.ProductType = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.BillOfMaterial = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.Discontinued = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.AttributeSet = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.AttributeSetValue = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.StandardCost = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.Price_Sales = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.Price_Purchase = new String(commonByteArray, 0,
								length);
					}
		...
		try {
			...
			while (limittFileInputDelimited_1 != 0
				...
				try {
					...
					if (rowtFileInputDelimited_1.length == 1
						...
						if (5 < rowtFileInputDelimited_1.length) {
							row1.ProductCategory = rowtFileInputDelimited_1[5]
									.trim();
						...
						if (7 < rowtFileInputDelimited_1.length) {
							row1.ProductType = rowtFileInputDelimited_1[7]
									.trim();
						...
						if (8 < rowtFileInputDelimited_1.length) {
							row1.Production = rowtFileInputDelimited_1[8]
									.trim();
						...
						if (9 < rowtFileInputDelimited_1.length) {
							row1.BillOfMaterial = rowtFileInputDelimited_1[9]
									.trim();
						...
						if (10 < rowtFileInputDelimited_1.length) {
							row1.Discontinued = rowtFileInputDelimited_1[10]
									.trim();
						...
						if (12 < rowtFileInputDelimited_1.length) {
							row1.AttributeSet = rowtFileInputDelimited_1[12]
									.trim();
						...
						if (13 < rowtFileInputDelimited_1.length) {
							row1.AttributeSetValue = rowtFileInputDelimited_1[13]
									.trim();
						...
						if (17 < rowtFileInputDelimited_1.length) {
							row1.TaxCategory = rowtFileInputDelimited_1[17]
									.trim();
						...
						if (18 < rowtFileInputDelimited_1.length) {
							row1.StandardCost = rowtFileInputDelimited_1[18]
									.trim();
						...
						if (19 < rowtFileInputDelimited_1.length) {
							row1.Price_Sales = rowtFileInputDelimited_1[19]
									.trim();
						...
						if (20 < rowtFileInputDelimited_1.length) {
							row1.Price_Purchase = rowtFileInputDelimited_1[20]
									.trim();
				...
				if (row1 != null) {
					...
					row4.Organization = validator
							.checkOrganization(row1.Organization);
					row4.SearchKey = validator.checkNotNull(validator
							.checkString(row1.SearchKey, 40), "SearchKey");
					row4.Name = validator.checkNotNull(validator.checkString(
							row1.Name, 60), "Name");
					row4.Description = validator.checkString(row1.Description,
							255);
					row4.UPC_EAN = validator.checkString(row1.UPC_EAN, 30);
					row4.ProductCategory = validator.checkNotNull(validator
							.checkString(row1.ProductCategory, 32, "Category"),
							"ProductCategory");
					row4.UOM = validator.checkNotNull(validator.checkString(
							row1.UOM, 32, "UOM"), "UOM");
					row4.ProductType = validator.checkNotNull(validator
							.checkString(row1.ProductType, 60, "ProductType"),
							"ProductType");
					row4.Production = validator.checkNotNull(validator
							.checkBoolean(row1.Production, "Production"),
							"Production");
					row4.BillOfMaterial = validator.checkNotNull(validator
							.checkBoolean(row1.BillOfMaterial,
									"BillOfMaterials"), "BillOfMaterial");
					row4.Discontinued = validator.checkNotNull(validator
							.checkBoolean(row1.Discontinued, "Discontinued"),
							"Discontinued");
					row4.CostType = validator.checkString(row1.CostType, 32,
							"CostType");
					row4.AttributeSet = validator.checkString(
							row1.AttributeSet, 60, "AttributeSet");
					row4.AttributeSetValue = validator.checkString(
							row1.AttributeSetValue, 60, "AttributeSetValue");
					row4.Stocked = validator.checkNotNull(validator
							.checkBoolean(row1.Stocked, "Stocked"), "Stocked");
					row4.Purchase = validator.checkNotNull(validator
							.checkBoolean(row1.Purchase, "Purchase"),
							"Purchase");
					row4.Sale = validator.checkNotNull(validator.checkBoolean(
							row1.Sale, "Sale"), "Sale");
					row4.TaxCategory = validator.checkNotNull(validator
							.checkString(row1.TaxCategory, 60, "TaxCategory"),
							"TaxCategory");
					row4.StandardCost = validator
							.checkBigDecimal(row1.StandardCost);
					row4.Price_Sales = validator
							.checkBigDecimal(row1.Price_Sales);
					row4.Price_Purchase = validator
							.checkBigDecimal(row1.Price_Purchase);
					...
					(row4.flag == null ? false : row4.flag.toLowerCase()
							.compareTo("0") == 0)
					...
					if (row2 != null) {
						...
						if (service.getReferenceValue("Cost Type",
                                                    row2.CostType) == null
                                                    && row2.CostType != null) {
						      row14.flag = "-1";
                                                      row14.whyError += service
						...
						if (row2.AttributeSet != null) {
							AttributeSet attributeSet = service
									.findDALInstance(
											false,
											AttributeSet.class,
							...
							if (attributeSet == null) {
                                                          row14.flag = "-1";
                                                          row14.whyError += service.Utility_messageBD("IDL_BAD_REFERENCE") + row2.AttributeSet + "\n";
                                                        }
							
							if (attributeSet != null && row2.AttributeSetValue != null && !attributeSet.isSerialNo()
                                                            && !attributeSet.isLot()) {
                                                              if (attributeSet.getAttributeUseList().size() == 1) {
                                                                  AttributeValue attvalue = service.findDALInstance(false,AttributeValue.class,
                                                                        new Value(AttributeValue.PROPERTY_ATTRIBUTE,attributeSet.getAttributeUseList().get(0).getAttribute()),
                                                                        new Value("name",row2.AttributeSetValue));
                                                                  if (attvalue == null) {
                                                                    row14.flag = "-1";
                                                                    row14.whyError += service.Utility_messageBD("IDL_BAD_REFERENCE") + row2.AttributeSetValue + "\n";
                                                                  }
                                                              }
                                                        }
						}
						...
						(row14.flag == null ? false : row14.flag.toLowerCase()
								.compareTo("0") == 0)
						...
						if (row60 != null) {
							...
							service.finishRecordProcess(row60.Organization,
									row60.SearchKey, row60.Name,
									row60.Description, row60.UPC_EAN,
									row60.ProductCategory, row60.UOM,
									row60.ProductType, row60.Production,
									row60.BillOfMaterial, row60.Discontinued,
									row60.CostType, row60.AttributeSet,
									row60.AttributeSetValue, row60.Stocked,
									row60.Purchase, row60.Sale,
									row60.TaxCategory, row60.StandardCost,
						...
						if (row21 != null) {
							...
							service.logRecordError(row21.whyError, row21.Organization,
									row21.SearchKey, row21.Name,
									row21.Description, row21.UPC_EAN,
									row21.ProductCategory, row21.UOM,
									row21.ProductType, row21.Production,
									row21.BillOfMaterial, row21.Discontinued,
									row21.CostType, row21.AttributeSet,
									row21.AttributeSetValue, row21.Stocked,
									row21.Purchase, row21.Sale,
									row21.TaxCategory, row21.StandardCost,
					...
					if (row6 != null) {
						...
						service.logRecordError(row6.whyError,
								row6.Organization, row6.SearchKey, row6.Name,
								row6.Description, row6.UPC_EAN,
								row6.ProductCategory, row6.UOM,
								row6.ProductType, row6.Production,
								row6.BillOfMaterial, row6.Discontinued,
								row6.CostType, row6.AttributeSet,
								row6.AttributeSetValue, row6.Stocked,
								row6.Purchase, row6.Sale, row6.TaxCategory,
								row6.StandardCost, row6.Price_Sales,
								row6.Price_Purchase);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			java.io.InputStream inContext = ProductJob.class
					.getClassLoader()
					.getResourceAsStream(
			...
			if (contextStr.compareTo("Default") != 0) {
				inContext = ProductJob.class.getClassLoader()
						.getResourceAsStream(
								"initial_data_load/productjob_0_1/contexts/"
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : ProductJob");
		}
...
/************************************************************************************************
 * 237644 characters generated by Talend Open Studio on the 17 de noviembre de
 * 2009 17:34:41 CET
 ************************************************************************************************/
