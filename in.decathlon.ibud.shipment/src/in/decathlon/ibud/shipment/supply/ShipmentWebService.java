...
public class ShipmentWebService implements WebService {

  public static final Logger log = Logger.getLogger(ShipmentWebService.class);
  GetSupplyShipmentData getSupplyShipmentData = new GetSupplyShipmentData();
  ...
  public void doGet(String path, HttpServletRequest request, HttpServletResponse response)
      throws Exception {
    log.debug(".........doGet.....");
    // String shipmentInJson = getShipmentDataInJson(request, response);
    getShipmentDataInJson(request, response);
    // writeResult(response, shipmentInJson);
    // log.debug(".........writeResult.....");

  }

  private void getShipmentDataInJson(HttpServletRequest request, HttpServletResponse response)
      throws Exception {
    ...
    log.debug(updated);
    log.debug("Enter getShipmentDataInJson");
    String orgId = request.getParameter("orgId");
    log.debug(orgId);
    bPartnerOrg = BusinessEntityMapper.getBPOfOrg(orgId);
    log.debug(bPartnerOrg);
    getSupplyShipmentData.getJsonShipmentOrders(bPartnerOrg, updated, response, "");
