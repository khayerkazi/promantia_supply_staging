 ...
 ************************************************************************
 */
package com.sysfore.sankalpcrm.info;
...
public class Location extends HttpSecureAppServlet {
  ...
  private LocationSearchData getEditVariables(VariablesSecureApp vars) {
    ...
    data.address3 = vars.getStringParameter("inpaddress3");
    data.address4 = vars.getStringParameter("inpaddress4");
  ...
  private void printPageFS(HttpServletResponse response, VariablesSecureApp vars)
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("com/sysfore/sankalpcrm/info/Location_FS")
        .createXmlDocument();
  ...
  private void printPageSheet(HttpServletResponse response, VariablesSecureApp vars,
    ...
    if (strcLocationId.equals("")) {
      xmlDocument = xmlEngine.readXmlTemplate("com/sysfore/sankalpcrm/info/Location_F1")
          .createXmlDocument();
  ...
  private void printPageF2(HttpServletResponse response, VariablesSecureApp vars,
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("com/sysfore/sankalpcrm/info/Location_F2")
        .createXmlDocument();
    // Getcountry; default
    try {
      ComboTableData comboTableData = new ComboTableData(vars, this, "TABLEDIR", "C_Region_ID", "",
