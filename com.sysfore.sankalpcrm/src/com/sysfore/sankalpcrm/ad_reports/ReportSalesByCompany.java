...
public class ReportSalesByCompany extends HttpSecureAppServlet 
{
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response)throws IOException,ServletException
 {
    ...
    if (vars.commandIn("DEFAULT")) 
    {
        ...
        String strDateFrom = vars.getRequestGlobalVariable("inpDateFrom", "ReportSalesByCompany|dateFrom");
        String strDateTo = vars.getRequestGlobalVariable("inpDateTo", "ReportSalesByCompany|dateTo");
     	String strOrg = vars.getRequestGlobalVariable("inpOrg", "ReportSalesByCompany|org");
        String strState = vars.getGlobalVariable("inpState", "ReportSalesByCompany|state","");
	String strTopxrecords =vars.getRequestGlobalVariable("inpTopxrecords","ReportSalesByCompany|topxrecords");
        
        printPageDataSheet(response, vars, strDateFrom, strDateTo, strOrg, strState, strTopxrecords);
        vars.setSessionValue("ReportSalesByCompany|state", "");
 ...
 void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars, String strDateFrom, String strDateTo, String strOrg, String strState, String strTopxrecords) throws IOException, ServletException
 {
   ...
   if (strOrg.equals("0"))
   {
   ReportSalesByCompanyData[] data = ReportSalesByCompanyData.select1(this, strDateFrom, DateTimeData.nDaysAfter(this, strDateTo, "1"), strState, strTopxrecords);

   }
   else
   {
   ReportSalesByCompanyData[] data = ReportSalesByCompanyData.select(this, strDateFrom, DateTimeData.nDaysAfter(this, strDateTo, "1"), strOrg, strState, strTopxrecords);
   }
 ...
 //ReportSalesByCompanyData[] data = ReportSalesByCompanyData.select(this, strDateFrom, DateTimeData.nDaysAfter(this, strDateTo, "1"), strOrg, strState, strTopxrecords);
    ...
    xmlDocument = xmlEngine.readXmlTemplate("com/sysfore/sankalpcrm/ad_reports/ReportSalesByCompany").createXmlDocument();
    ...
    try 
    {
      WindowTabs tabs = new WindowTabs(this, vars, "com.sysfore.sankalpcrm.ad_reports.ReportSalesByCompany");
      xmlDocument.setParameter("parentTabContainer", tabs.parentTabs());
      xmlDocument.setParameter("mainTabContainer", tabs.mainTabs());
      xmlDocument.setParameter("childTabContainer", tabs.childTabs());
      xmlDocument.setParameter("theme", vars.getTheme());
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "ReportSalesByCompany.html", classInfo.id,    classInfo.type, strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "ReportSalesByCompany.html", strReplaceWith);
    ...
    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "ReportSalesByCompany", false, "", "", "",false, "ad_reports",  strReplaceWith, false,  true);
    ...
    OBError myMessage = vars.getMessage("ReportSalesByCompany");
    vars.removeMessage("ReportSalesByCompany");
    if (myMessage!=null) {
    ...
    //ReportSalesByCompanyData[] state = ReportSalesByCompanyData.selectState(this, "0");
    ...
    System.out.println("Try Block1 Starts");
            ...
            try
	    {
	      ComboTableData comboTableData = new ComboTableData(vars, this, "TABLEDIR", "ad_org_id",
	          "", "", Utility.getContext(this, vars, "#AccessibleOrgTree", "ReportSalesByCompany"),
	          Utility.getContext(this, vars, "#User_Client", "ReportSalesByCompany"), 0);
	      Utility.fillSQLParameters(this, vars, null, comboTableData, "ReportSalesByCompany", strOrg);
...
/*try 
          ...
          "", "", Utility.getContext(this, vars, "#AccessibleOrgTree", "ReportSalesByCompany"),
          Utility.getContext(this, vars, "#User_Client", "ReportSalesByCompany"), 0);
      Utility.fillSQLParameters(this, vars, null, comboTableData, "ReportSalesByCompany", state);
...
void printPageHtml(HttpServletRequest request, HttpServletResponse response, VariablesSecureApp vars,String strDateFrom, String strDateTo, String strOrg, String strState, String strTopxrecords) throws IOException, ServletException 
{
    ...
    ReportSalesByCompanyData[] data = null;
    ...
    try 
    {
       ...
       data = ReportSalesByCompanyData.select(this,  strDateFrom, DateTimeData.nDaysAfter(this, strDateTo, "1"), strOrg, strState, strTopxrecords);
    } 
    ...
    strConvRateErrorMsg = myMessage.getMessage();
      ...
      String strReportName = "@basedesign@/com/sysfore/sankalpcrm/ad_reports/ReportSalesByCompany.jrxml";
...
void printPageXls( HttpServletResponse response, VariablesSecureApp vars,String strDateFrom, String strDateTo, String strOrg, String strState, String strTopxrecords) throws IOException, ServletException 
{
      ...
      String strReportName = "@basedesign@/com/sysfore/sankalpcrm/ad_reports/ReportSalesByCompany1.jrxml";
      String strTitle = "";
      String  strSubTitle = "";
      ...
      response.setHeader("Content-disposition","inline;filename=ReportSalesByCompany1.xls");
      HashMap<String, Object> parameters = new HashMap<String, Object>();
...
{
    return "ReportSalesByCompany for displaying excel format";
